...
2273                     ; 168 void gran(signed short *adr, signed short min, signed short max)
2273                     ; 169 {
2275                     	switch	.text
2276  0000               _gran:
2278  0000 89            	pushw	x
2279       00000000      OFST:	set	0
2282                     ; 170 if (*adr<min) *adr=min;
2284  0001 9c            	rvf
...
2315  001f 85            	popw	x
2316  0020 81            	ret
2369                     ; 175 void granee(@eeprom signed short *adr, signed short min, signed short max)
2369                     ; 176 {
2370                     	switch	.text
2371  0021               _granee:
2373  0021 89            	pushw	x
2374       00000000      OFST:	set	0
2377                     ; 177 if (*adr<min) *adr=min;
2379  0022 9c            	rvf
...
2417  004a 85            	popw	x
2418  004b 81            	ret
2479                     ; 182 long delay_ms(short in)
2479                     ; 183 {
2480                     	switch	.text
2481  004c               _delay_ms:
2483  004c 520c          	subw	sp,#12
2484       0000000c      OFST:	set	12
2487                     ; 186 i=((long)in)*100UL;
...
2633  00e3               L7751:
2634                     ; 227 		else if((link==ON)&&(flags_tu&0b10000000))
...
2657  0107               L3061:
2658                     ; 233 		else if(((main_cnt1>(5*ee_TZAS))&&(main_cnt1<(100+(5*ee_TZAS)))) && (ee_AVT_MODE!=0x55)&& (!ee_DEVICE))
2660  0107 9c            	rvf
...
2717  016b               L3161:
2718                     ; 245 		else if((link==ON)&&((flags&0b00111110)==0))
...
2822  0200               L7361:
2823                     ; 272 		else if((link==ON)&&(flags&0b00100000))
...
2916  028f               L7561:
2917                     ; 296 		else if((main_cnt1>(5*ee_TZAS))&&(main_cnt1<(70+(5*ee_TZAS))))
2919  028f 9c            	rvf
...
3089  039c               L7171:
3090                     ; 341 		else if((link==ON)&&(flags_tu&0b10000000))
...
3113  03c0               L3271:
3114                     ; 347 		else if(((main_cnt1>(5*ee_TZAS))&&(main_cnt1<(100+(5*ee_TZAS)))) && (ee_AVT_MODE!=0x55)&& (!ee_DEVICE))
3116  03c0 9c            	rvf
...
3184  0434               L7371:
3185                     ; 359 				else led_green=0xffffffffL;
...
3217  0469               L7471:
3218                     ; 366 				else led_green=0xffffffffL;	
...
3249  049c               L7571:
3250                     ; 372 				else led_green=0x00000000L;
...
3281  04cf               L7671:
3282                     ; 378 				else led_green=0x00000000L;	
...
3313  0502               L7771:
3314                     ; 384 				else led_green=0x00000000L;	
...
3335  0528               L3371:
3336                     ; 405 		else if((link==ON)&&((flags&0b00111110)==0))
...
3440  05bd               L7202:
3441                     ; 432 		else if((link==ON)&&(flags&0b00100000))
...
3534  064c               L7402:
3535                     ; 458 		else if((main_cnt1>(5*ee_TZAS))&&(main_cnt1<(70+(5*ee_TZAS))))
3537  064c 9c            	rvf
...
3667                     ; 493 }
3670  0710 81            	ret
3698                     ; 496 void led_drv(void)
3698                     ; 497 {
3699                     	switch	.text
3700  0711               _led_drv:
3704                     ; 499 GPIOA->DDR|=(1<<6);
3706  0711 721c5002      	bset	20482,#6
3707                     ; 500 GPIOA->CR1|=(1<<6);
3709  0715 721c5003      	bset	20483,#6
3710                     ; 501 GPIOA->CR2&=~(1<<6);
3712  0719 721d5004      	bres	20484,#6
3713                     ; 502 if(led_red_buff&0b1L) GPIOA->ODR|=(1<<6); 	//Горит если в led_red_buff 1 и на ножке 1
...
3723  0729               L1112:
3724                     ; 503 else GPIOA->ODR&=~(1<<6); 
3726  0729 721d5000      	bres	20480,#6
3727  072d               L3112:
3728                     ; 506 GPIOA->DDR|=(1<<5);
3730  072d 721a5002      	bset	20482,#5
3731                     ; 507 GPIOA->CR1|=(1<<5);
3733  0731 721a5003      	bset	20483,#5
3734                     ; 508 GPIOA->CR2&=~(1<<5);	
3736  0735 721b5004      	bres	20484,#5
3737                     ; 509 if(led_green_buff&0b1L) GPIOA->ODR|=(1<<5);	//Горит если в led_green_buff 1 и на ножке 1
...
3747  0745               L5112:
3748                     ; 510 else GPIOA->ODR&=~(1<<5);
3750  0745 721b5000      	bres	20480,#5
3751  0749               L7112:
3752                     ; 513 led_red_buff>>=1;
...
3779                     ; 519 	led_green_buff=led_green;
...
3853  079d               L3312:
3854                     ; 547 else if(!(GPIOD->IDR&(1<<6)))
...
3881  07bb               L5412:
3882                     ; 562 else if(!(GPIOD->IDR&(1<<7)))
...
3894  07c8               L1512:
3895                     ; 571 if((cnt_JP0==10)&&(cnt_JP1==10))
...
3904                     ; 573 	jp_mode=jp0;
3906  07d4 3f4b          	clr	_jp_mode
3907  07d6               L7512:
3908                     ; 575 if((cnt_JP0==0)&&(cnt_JP1==10))
...
3916                     ; 577 	jp_mode=jp1;
3918  07e0 3501004b      	mov	_jp_mode,#1
3919  07e4               L1612:
3920                     ; 579 if((cnt_JP0==10)&&(cnt_JP1==0))
...
4008  0819               L3022:
4009                     ; 597 	if(link_cnt==50)
4011  0819 b662          	ld	a,_link_cnt
4012  081b a132          	cp	a,#50
4013  081d 262e          	jrne	L5122
4014                     ; 599 		link=OFF;
4016  081f 35aa0063      	mov	_link,#170
4017                     ; 604 		if(bps_class==bpsIPS)bMAIN=1;	//если БПС определен как ИПСный - пытаться стать главным;
...
4027  082f               L7022:
4028                     ; 605 		else bMAIN=0;
4030  082f 72110001      	bres	_bMAIN
4031  0833               L1122:
4032                     ; 607 		cnt_net_drv=0;
...
4131                     ; 620 void vent_drv(void)
4131                     ; 621 {
4132                     	switch	.text
4133  084e               _vent_drv:
4135  084e 520e          	subw	sp,#14
4136       0000000e      OFST:	set	14
4139                     ; 624 	short vent_pwm_i_necc=400;
4141  0850 ae0190        	ldw	x,#400
4142  0853 1f07          	ldw	(OFST-7,sp),x
4143                     ; 625 	short vent_pwm_t_necc=400;
4145  0855 ae0190        	ldw	x,#400
4146  0858 1f09          	ldw	(OFST-5,sp),x
4147                     ; 626 	short vent_pwm_max_necc=400;
4149                     ; 631 	tempSL=36000L/(signed long)ee_Umax;
...
4170                     ; 632 	tempSL=(signed long)I/tempSL;
...
4183                     ; 634 	if(ee_DEVICE==1) tempSL=(signed long)(I/ee_IMAXVENT);
...
4200  08ad               L1522:
4201                     ; 636 	if(tempSL>10)vent_pwm_i_necc=1000;
4203  08ad 9c            	rvf
...
4218  08c4               L3522:
4219                     ; 637 	else if(tempSL<1)vent_pwm_i_necc=400;
4221  08c4 9c            	rvf
...
4236  08db               L7522:
4237                     ; 638 	else vent_pwm_i_necc=(short)(400L + (tempSL*60L));
...
4245  08e9               L5522:
4246                     ; 639 	gran(&vent_pwm_i_necc,400,1000);
...
4271                     ; 642 	if(tempSL<=(ee_tsign-30L))vent_pwm_t_necc=400;
4273  090f 9c            	rvf
...
4291  092b               L3622:
4292                     ; 643 	else if(tempSL>=ee_tsign)vent_pwm_t_necc=1000;
4294  092b 9c            	rvf
...
4309  0942               L7622:
4310                     ; 644 	else vent_pwm_t_necc=(short)(400L+(20L*(tempSL-(((signed long)ee_tsign)-30L))));
...
4322  095b               L5622:
4323                     ; 645 	gran(&vent_pwm_t_necc,400,1000);
...
4334                     ; 647 	vent_pwm_max_necc=vent_pwm_i_necc;
4336  096c 1e07          	ldw	x,(OFST-7,sp)
4337  096e 1f05          	ldw	(OFST-9,sp),x
4338                     ; 648 	if(vent_pwm_t_necc>vent_pwm_i_necc)vent_pwm_max_necc=vent_pwm_t_necc;
4340  0970 9c            	rvf
...
4348  097b               L3722:
4349                     ; 650 	if(vent_pwm<vent_pwm_max_necc)vent_pwm+=10;
4351  097b 9c            	rvf
...
4360  0989               L5722:
4361                     ; 651 	if(vent_pwm>vent_pwm_max_necc)vent_pwm-=10;
4363  0989 9c            	rvf
...
4372  0997               L7722:
4373                     ; 652 	gran(&vent_pwm,400,1000);
...
4436                     ; 666 if(main_cnt1<1500)main_cnt1++;
4438  09b6 9c            	rvf
...
4447  09c5               L1132:
4448                     ; 668 if((main_cnt1<(5*ee_TZAS))&&(bps_class!=bpsIPS))
4450  09c5 9c            	rvf
...
4466  09e1               L3132:
4467                     ; 673 else if(bps_class==bpsIPS)
...
4490  0a01               L7132:
4491                     ; 687 else if(((main_cnt1>(5*ee_TZAS))&&(main_cnt1<(70+(5*ee_TZAS)))))
4493  0a01 9c            	rvf
...
4538  0a43               L3432:
4539                     ; 699 			else	BLOCK_OFF //GPIOB->ODR&=~(1<<2);
...
4577                     ; 729 TIM1->CCR2H= (char)(pwm_u/256);	
...
4585                     ; 730 TIM1->CCR2L= (char)pwm_u;
4587  0a84 55000c5268    	mov	21096,_pwm_u+1
4588                     ; 732 TIM1->CCR1H= (char)(pwm_i/256);	
...
4596                     ; 733 TIM1->CCR1L= (char)pwm_i;
4598  0a96 55000e5266    	mov	21094,_pwm_i+1
4599                     ; 735 TIM1->CCR3H= (char)(vent_pwm/256);	
...
4676  0ac7               L3732:
4677                     ; 752 	else if(flags&0b00001010)
...
4807  0b67               L5242:
4808                     ; 805 		else if(flags&0b00011010)
...
4828  0b7d               L7142:
4829                     ; 819 else	if(link==ON)				//если есть связь
4831  0b7d b663          	ld	a,_link
4832  0b7f a155          	cp	a,#85
4833  0b81 2646          	jrne	L1042
4834                     ; 821 	if((flags&0b00100000)==0)	//если нет блокировки извне
4836  0b83 b60a          	ld	a,_flags
4837  0b85 a520          	bcp	a,#32
4838  0b87 2630          	jrne	L7342
4839                     ; 823 		if(((flags&0b00011010)==0)||(flags&0b01000000)) 	//если нет аварий или если они заблокированы
...
4848  0b95               L3442:
4849                     ; 825 			pwm_u=vol_u_temp+_x_;					//управление от укушки + выравнивание токов
4851  0b95 be5f          	ldw	x,__x_
4852  0b97 72bb0059      	addw	x,_vol_u_temp
4853  0b9b bf0b          	ldw	_pwm_u,x
4854                     ; 826 		    	pwm_i=vol_i_temp;
...
4863  0ba7               L1442:
4864                     ; 829 		else if(flags&0b00011010)					//если есть аварии
4866  0ba7 b60a          	ld	a,_flags
4867  0ba9 a51a          	bcp	a,#26
4868  0bab 271c          	jreq	L1042
4869                     ; 831 			pwm_u=0;								//то полный стоп
4871  0bad 5f            	clrw	x
...
4881  0bb9               L7342:
4882                     ; 836 	else if(flags&0b00100000)	//если заблокирован извне то полное выключение
...
4951                     ; 849 void matemat(void)
4951                     ; 850 {
4952                     	switch	.text
4953  0bca               _matemat:
4955  0bca 5204          	subw	sp,#4
4956       00000004      OFST:	set	4
4959                     ; 871 temp_SL=adc_buff_[4];
...
4977                     ; 873 if(temp_SL<0) temp_SL=0;
4979  0be6 9c            	rvf
...
5011                     ; 876 I=(signed short)temp_SL;
5013  0c16 1e03          	ldw	x,(OFST-1,sp)
5014  0c18 bf6f          	ldw	_I,x
5015                     ; 881 temp_SL=(signed long)adc_buff_[1];
...
5024                     ; 883 if(temp_SL<0) temp_SL=0;
5026  0c27 9c            	rvf
...
5035  0c36               L5742:
5036                     ; 884 temp_SL*=(signed long)ee_K[2][1];
...
5058                     ; 886 Ui=(unsigned short)temp_SL;
5060  0c57 1e03          	ldw	x,(OFST-1,sp)
5061  0c59 bf6b          	ldw	_Ui,x
5062                     ; 893 temp_SL=adc_buff_[3];
...
5071                     ; 895 if(temp_SL<0) temp_SL=0;
5073  0c68 9c            	rvf
...
5105                     ; 898 Un=(unsigned short)temp_SL;
5107  0c98 1e03          	ldw	x,(OFST-1,sp)
5108  0c9a bf6d          	ldw	_Un,x
5109                     ; 901 temp_SL=adc_buff_[2];
...
5140                     ; 904 T=(signed short)(temp_SL-273L);
...
5183  0cf7 81            	ret
5214                     ; 919 void temper_drv(void)		//1 Hz
5214                     ; 920 {
5215                     	switch	.text
5216  0cf8               _temper_drv:
5220                     ; 922 if(T>ee_tsign) tsign_cnt++;
5222  0cf8 9c            	rvf
5223  0cf9 5f            	clrw	x
...
5238  0d0e               L5152:
5239                     ; 923 else if (T<(ee_tsign-1)) tsign_cnt--;
5241  0d0e 9c            	rvf
...
5269                     ; 927 if(tsign_cnt>=55)
5271  0d39 9c            	rvf
5272  0d3a be4e          	ldw	x,_tsign_cnt
5273  0d3c a30037        	cpw	x,#55
5274  0d3f 2f16          	jrslt	L3252
5275                     ; 929 	if(((jp_mode==jp0)&&!(flags&0b01000000))||(jp_mode==jp3))	flags|=0b00000100; //поднять бит подогрева 
...
5293  0d57               L3252:
5294                     ; 931 else if (tsign_cnt<=5) flags&=0b11111011;	//Сбросить бит подогрева
5296  0d57 9c            	rvf
...
5303  0d63               L3352:
5304                     ; 936 if(T>ee_tmax) tmax_cnt++;
5306  0d63 9c            	rvf
5307  0d64 5f            	clrw	x
...
5322  0d79               L7352:
5323                     ; 937 else if (T<(ee_tmax-1)) tmax_cnt--;
5325  0d79 9c            	rvf
...
5353                     ; 941 if(tmax_cnt>=55)
5355  0da4 9c            	rvf
5356  0da5 be4c          	ldw	x,_tmax_cnt
5357  0da7 a30037        	cpw	x,#55
5358  0daa 2f16          	jrslt	L5452
5359                     ; 943 	if(((jp_mode==jp0)&&!(flags&0b01000000))||(jp_mode==jp3))	flags|=0b00000010;
...
5377  0dc2               L5452:
5378                     ; 945 else if (tmax_cnt<=5) flags&=0b11111101;
5380  0dc2 9c            	rvf
...
5388                     ; 948 } 
5391  0dce 81            	ret
5423                     ; 951 void u_drv(void)		//1Hz
5423                     ; 952 { 
5424                     	switch	.text
5425  0dcf               _u_drv:
5429                     ; 953 if(jp_mode!=jp3)
5431  0dcf b64b          	ld	a,_jp_mode
5432  0dd1 a103          	cp	a,#3
5433  0dd3 2770          	jreq	L1752
5434                     ; 955 	if(Ui>ee_Umax)umax_cnt++;
5436  0dd5 9c            	rvf
...
5447  0de6               L3752:
5448                     ; 956 	else umax_cnt=0;
5450  0de6 5f            	clrw	x
5451  0de7 bf66          	ldw	_umax_cnt,x
5452  0de9               L5752:
5453                     ; 957 	gran(&umax_cnt,0,10);
...
5463                     ; 958 	if(umax_cnt>=10)flags|=0b00001000; 	//Поднять аварию по превышению напряжения
5465  0df7 9c            	rvf
...
5472  0e03               L7752:
5473                     ; 961 	if((Ui<Un)&&((Un-Ui)>ee_dU)&&(!BLOCK_IS_ON/*(GPIOB->ODR&(1<<2))*/))umin_cnt++;	
5475  0e03 9c            	rvf
...
5496  0e26               L1062:
5497                     ; 962 	else umin_cnt=0;
5499  0e26 5f            	clrw	x
5500  0e27 bf64          	ldw	_umin_cnt,x
5501  0e29               L3062:
5502                     ; 963 	gran(&umin_cnt,0,10);	
...
5512                     ; 964 	if(umin_cnt>=10)flags|=0b00010000;	  
5514  0e37 9c            	rvf
...
5541  0e5c               L3162:
5542                     ; 969 	else umax_cnt=0;
5544  0e5c 5f            	clrw	x
5545  0e5d bf66          	ldw	_umax_cnt,x
5546  0e5f               L5162:
5547                     ; 970 	gran(&umax_cnt,0,10);
...
5557                     ; 971 	if(umax_cnt>=10)flags|=0b00001000;
5559  0e6d 9c            	rvf
...
5566  0e79               L7162:
5567                     ; 974 	if((Ui<200)&&(!BLOCK_IS_ON/*(GPIOB->ODR&(1<<2))*/))umin_cnt++;	
5569  0e79 9c            	rvf
...
5584  0e91               L1262:
5585                     ; 975 	else umin_cnt=0;
5587  0e91 5f            	clrw	x
5588  0e92 bf64          	ldw	_umin_cnt,x
5589  0e94               L3262:
5590                     ; 976 	gran(&umin_cnt,0,10);	
...
5600                     ; 977 	if(umin_cnt>=10)flags|=0b00010000;	  
5602  0ea2 9c            	rvf
...
5682  0edf               L7362:
5683                     ; 996 else _x_cnt=0;
5685  0edf 5f            	clrw	x
5686  0ee0 bf5b          	ldw	__x_cnt,x
5687  0ee2               L7462:
5688                     ; 998 if(_x_cnt>60) _x_cnt=0;	
5690  0ee2 9c            	rvf
...
5703                     ; 1001 }
5706  0ef1 81            	ret
5732                     ; 1004 void apv_start(void)
5732                     ; 1005 {
5733                     	switch	.text
5734  0ef2               _apv_start:
5738                     ; 1006 if((apv_cnt[0]==0)&&(apv_cnt[1]==0)&&(apv_cnt[2]==0)&&!bAPV)
...
5768                     ; 1014 }
5771  0f1a 81            	ret
5797                     ; 1017 void apv_stop(void)
5797                     ; 1018 {
5798                     	switch	.text
5799  0f1b               _apv_stop:
5803                     ; 1019 apv_cnt[0]=0;
5805  0f1b 3f46          	clr	_apv_cnt
5806                     ; 1020 apv_cnt[1]=0;
5808  0f1d 3f47          	clr	_apv_cnt+1
5809                     ; 1021 apv_cnt[2]=0;
5811  0f1f 3f48          	clr	_apv_cnt+2
5812                     ; 1022 apv_cnt_=0;	
5814  0f21 5f            	clrw	x
...
5993  0fa3               L5272:
5994                     ; 1083 if((umin_cnt==0)&&(umax_cnt==0)/*&&(cnt_adc_ch_2_delta==0)*/&&(!BLOCK_IS_ON/*(GPIOB->ODR&(1<<2))*/))
...
6036  0000 00            	ds.b	1
6072                     ; 1099 void flags_drv(void)
6072                     ; 1100 {
6073                     	switch	.text
6074  0fc8               _flags_drv:
6078                     ; 1102 if(jp_mode!=jp3) 
6080  0fc8 b64b          	ld	a,_jp_mode
6081  0fca a103          	cp	a,#3
6082  0fcc 2723          	jreq	L1672
6083                     ; 1104 	if(((flags&(1<<3)/*0b00001000*/)&&(!(flags_old&(1<<3)/*0b00001000*/)))||((flags&(1<<4)/*0b00010000*/)&&(!(flags_old&(1<<4)/*0b00010000*/)))) 
...
6101  0fe6               L5672:
6102                     ; 1106     		if(link==OFF)apv_start();
...
6112  0ff1               L1672:
6113                     ; 1109 else if(jp_mode==jp3) 
6115  0ff1 b64b          	ld	a,_jp_mode
6116  0ff3 a103          	cp	a,#3
6117  0ff5 260f          	jrne	L3772
6118                     ; 1111 	if((flags&(1<<3)/*0b00001000*/)&&(!(flags_old&(1<<3)/*0b00001000*/))) 
...
6131  1006               L3772:
6132                     ; 1116 flags_old=flags;
6134  1006 450a00        	mov	L1472_flags_old,_flags
6135                     ; 1118 } 
6138  1009 81            	ret
6172                     ; 1257 char adr_gran(signed short in)
6172                     ; 1258 {
6173                     	switch	.text
6174  100a               _adr_gran:
6176  100a 89            	pushw	x
6177       00000000      OFST:	set	0
6180                     ; 1259 if(in>1000)return 1;
6182  100b 9c            	rvf
...
6190  1015               L7103:
6191                     ; 1260 else if((in>60)&&(in<140))return 0;
6193  1015 9c            	rvf
...
6370  10c3               L1603:
6371                     ; 1308 else if((adc_buff_[0]>=(ADR_CONST_1-20))&&(adc_buff_[0]<=(ADR_CONST_1+20))) adr[0]=1;
6373  10c3 9c            	rvf
...
6387  10db               L5603:
6388                     ; 1309 else if((adc_buff_[0]>=(ADR_CONST_2-20))&&(adc_buff_[0]<=(ADR_CONST_2+20))) adr[0]=2;
6390  10db 9c            	rvf
...
6404  10f3               L1703:
6405                     ; 1310 else if((adc_buff_[0]>=(ADR_CONST_3-20))&&(adc_buff_[0]<=(ADR_CONST_3+20))) adr[0]=3;
6407  10f3 9c            	rvf
...
6421  110b               L5703:
6422                     ; 1311 else adr[0]=5;
6424  110b 35050002      	mov	_adr,#5
6425  110f               L3603:
6426                     ; 1313 if((adc_buff_[1]>=(ADR_CONST_0-20))&&(adc_buff_[1]<=(ADR_CONST_0+20))) adr[1]=0;
6428  110f 9c            	rvf
...
6442  1127               L1013:
6443                     ; 1314 else if((adc_buff_[1]>=(ADR_CONST_1-20))&&(adc_buff_[1]<=(ADR_CONST_1+20))) adr[1]=1;
6445  1127 9c            	rvf
...
6459  113f               L5013:
6460                     ; 1315 else if((adc_buff_[1]>=(ADR_CONST_2-20))&&(adc_buff_[1]<=(ADR_CONST_2+20))) adr[1]=2;
6462  113f 9c            	rvf
...
6476  1157               L1113:
6477                     ; 1316 else if((adc_buff_[1]>=(ADR_CONST_3-20))&&(adc_buff_[1]<=(ADR_CONST_3+20))) adr[1]=3;
6479  1157 9c            	rvf
...
6493  116f               L5113:
6494                     ; 1317 else adr[1]=5;
6496  116f 35050003      	mov	_adr+1,#5
6497  1173               L3013:
6498                     ; 1319 if((adc_buff_[9]>=(ADR_CONST_0-20))&&(adc_buff_[9]<=(ADR_CONST_0+20))) adr[2]=0;
6500  1173 9c            	rvf
...
6514  118b               L1213:
6515                     ; 1320 else if((adc_buff_[9]>=(ADR_CONST_1-20))&&(adc_buff_[9]<=(ADR_CONST_1+20))) adr[2]=1;
6517  118b 9c            	rvf
...
6531  11a3               L5213:
6532                     ; 1321 else if((adc_buff_[9]>=(ADR_CONST_2-20))&&(adc_buff_[9]<=(ADR_CONST_2+20))) adr[2]=2;
6534  11a3 9c            	rvf
...
6548  11bb               L1313:
6549                     ; 1322 else if((adc_buff_[9]>=(ADR_CONST_3-20))&&(adc_buff_[9]<=(ADR_CONST_3+20))) adr[2]=3;
6551  11bb 9c            	rvf
...
6565  11d3               L5313:
6566                     ; 1323 else adr[2]=5;
6568  11d3 35050004      	mov	_adr+2,#5
6569  11d7               L3213:
6570                     ; 1327 if((adr[0]==5)||(adr[1]==5)||(adr[2]==5))
...
6593  11f1 81            	ret
6594  11f2               L1413:
6595                     ; 1334 	if(adr[2]&0x02) bps_class=bpsIPS;
...
6605  11ff               L1513:
6606                     ; 1335 	else bps_class=bpsIBEP;
6608  11ff 3f05          	clr	_bps_class
6609  1201               L3513:
6610                     ; 1337 	adress = adr[0] + (adr[1]*4) + ((adr[2]&0x01)*16);
...
6989  138f 81            	ret
7033                     ; 1432 void volum_u_main_drv(void)
7033                     ; 1433 {
7034                     	switch	.text
...
7046  139b               L431:
7047                     ; 1438 	if(Un<(UU_AVT-10))volum_u_main_+=5;
7049  139b 9c            	rvf
...
7061  13af               L3723:
7062                     ; 1439 	else if(Un<(UU_AVT-1))volum_u_main_++;
7064  13af 9c            	rvf
...
7076  13c1               L7723:
7077                     ; 1440 	else if(Un>(UU_AVT+10))volum_u_main_-=10;
7079  13c1 9c            	rvf
...
7091  13d5               L3033:
7092                     ; 1441 	else if(Un>(UU_AVT+1))volum_u_main_--;
7094  13d5 9c            	rvf
...
7104  13e5               L5723:
7105                     ; 1442 	if(volum_u_main_>1020)volum_u_main_=1020;
7107  13e5 9c            	rvf
...
7115  13f2               L1133:
7116                     ; 1443 	if(volum_u_main_<0)volum_u_main_=0;
7118  13f2 9c            	rvf
...
7227  1475               L7333:
7228                     ; 1467 			else if(i_main[i]>(i_main_avg+10))x[i]--;
7230  1475 9c            	rvf
...
7305  14e1 84            	pop	a
7306  14e2 81            	ret
7329                     ; 1479 void init_CAN(void) {
7330                     	switch	.text
7331  14e3               _init_CAN:
7335                     ; 1480 	CAN->MCR&=~CAN_MCR_SLEEP;					// CAN wake up request
7337  14e3 72135420      	bres	21536,#1
7338                     ; 1481 	CAN->MCR|= CAN_MCR_INRQ;					// CAN initialization request
7340  14e7 72105420      	bset	21536,#0
7342  14eb               L3633:
7343                     ; 1482 	while((CAN->MSR & CAN_MSR_INAK) == 0);	// waiting for CAN enter the init mode
7345  14eb c65421        	ld	a,21537
7346  14ee a501          	bcp	a,#1
7347  14f0 27f9          	jreq	L3633
7348                     ; 1484 	CAN->MCR|= CAN_MCR_NART;					// no automatic retransmition
7350  14f2 72185420      	bset	21536,#4
7351                     ; 1486 	CAN->PSR= 2;							// *** FILTER 0 SETTINGS ***
7353  14f6 35025427      	mov	21543,#2
7354                     ; 1495 	CAN->Page.Filter01.F0R1= UKU_MESS_STID>>3;			// 16 bits mode
7356  14fa 35135428      	mov	21544,#19
7357                     ; 1496 	CAN->Page.Filter01.F0R2= UKU_MESS_STID<<5;
7359  14fe 35c05429      	mov	21545,#192
7360                     ; 1497 	CAN->Page.Filter01.F0R5= UKU_MESS_STID_MASK>>3;
7362  1502 357f542c      	mov	21548,#127
7363                     ; 1498 	CAN->Page.Filter01.F0R6= UKU_MESS_STID_MASK<<5;
7365  1506 35e0542d      	mov	21549,#224
7366                     ; 1500 	CAN->Page.Filter01.F1R1= BPS_MESS_STID>>3;			// 16 bits mode
7368  150a 35315430      	mov	21552,#49
7369                     ; 1501 	CAN->Page.Filter01.F1R2= BPS_MESS_STID<<5;
7371  150e 35c05431      	mov	21553,#192
7372                     ; 1502 	CAN->Page.Filter01.F1R5= BPS_MESS_STID_MASK>>3;
7374  1512 357f5434      	mov	21556,#127
7375                     ; 1503 	CAN->Page.Filter01.F1R6= BPS_MESS_STID_MASK<<5;
7377  1516 35e05435      	mov	21557,#224
7378                     ; 1507 	CAN->PSR= 6;									// set page 6
7380  151a 35065427      	mov	21543,#6
7381                     ; 1512 	CAN->Page.Config.FMR1&=~3;								//mask mode
7383  151e c65430        	ld	a,21552
7384  1521 a4fc          	and	a,#252
7385  1523 c75430        	ld	21552,a
7386                     ; 1518 	CAN->Page.Config.FCR1= ((3<<1) & (CAN_FCR1_FSC00 | CAN_FCR1_FSC01));		//16 bit scale
7388  1526 35065432      	mov	21554,#6
7389                     ; 1519 	CAN->Page.Config.FCR1= ((3<<5) & (CAN_FCR1_FSC10 | CAN_FCR1_FSC11));		//16 bit scale
7391  152a 35605432      	mov	21554,#96
7392                     ; 1522 	CAN->Page.Config.FCR1|= CAN_FCR1_FACT0;	// filter 0 active
7394  152e 72105432      	bset	21554,#0
7395                     ; 1523 	CAN->Page.Config.FCR1|= CAN_FCR1_FACT1;
7397  1532 72185432      	bset	21554,#4
7398                     ; 1526 	CAN->PSR= 6;								// *** BIT TIMING SETTINGS ***
7400  1536 35065427      	mov	21543,#6
7401                     ; 1528 	CAN->Page.Config.BTR1= 9;					// CAN_BTR1_BRP=9, 	tq= fcpu/(9+1)
7403  153a 3509542c      	mov	21548,#9
7404                     ; 1529 	CAN->Page.Config.BTR2= (1<<7)|(6<<4) | 7; 		// BS2=8, BS1=7, 		
7406  153e 35e7542d      	mov	21549,#231
7407                     ; 1531 	CAN->IER|=(1<<1);
7409  1542 72125425      	bset	21541,#1
7410                     ; 1534 	CAN->MCR&=~CAN_MCR_INRQ;					// leave initialization request
7412  1546 72115420      	bres	21536,#0
7414  154a               L1733:
7415                     ; 1535 	while((CAN->MSR & CAN_MSR_INAK) != 0);	// waiting for CAN leave the init mode
7417  154a c65421        	ld	a,21537
7418  154d a501          	bcp	a,#1
7419  154f 26f9          	jrne	L1733
7420                     ; 1536 }
7423  1551 81            	ret
7531                     ; 1539 void can_transmit(unsigned short id_st,char data0,char data1,char data2,char data3,char data4,char data5,char data6,char data7)
7531                     ; 1540 {
7532                     	switch	.text
7533  1552               _can_transmit:
7535  1552 89            	pushw	x
7536       00000000      OFST:	set	0
7539                     ; 1542 if((can_buff_wr_ptr<0)||(can_buff_wr_ptr>3))can_buff_wr_ptr=0;
7541  1553 b675          	ld	a,_can_buff_wr_ptr
7542  1555 a104          	cp	a,#4
7543  1557 2502          	jrult	L3543
7546  1559 3f75          	clr	_can_buff_wr_ptr
7547  155b               L3543:
7548                     ; 1544 can_out_buff[can_buff_wr_ptr][0]=(char)(id_st>>6);
7550  155b b675          	ld	a,_can_buff_wr_ptr
...
7561  156c e776          	ld	(_can_out_buff,x),a
7562                     ; 1545 can_out_buff[can_buff_wr_ptr][1]=(char)(id_st<<2);
7564  156e b675          	ld	a,_can_buff_wr_ptr
...
7569  1576 48            	sll	a
7570  1577 48            	sll	a
7571  1578 e777          	ld	(_can_out_buff+1,x),a
7572                     ; 1547 can_out_buff[can_buff_wr_ptr][2]=data0;
7574  157a b675          	ld	a,_can_buff_wr_ptr
7575  157c 97            	ld	xl,a
7576  157d a610          	ld	a,#16
7577  157f 42            	mul	x,a
7578  1580 7b05          	ld	a,(OFST+5,sp)
7579  1582 e778          	ld	(_can_out_buff+2,x),a
7580                     ; 1548 can_out_buff[can_buff_wr_ptr][3]=data1;
7582  1584 b675          	ld	a,_can_buff_wr_ptr
7583  1586 97            	ld	xl,a
7584  1587 a610          	ld	a,#16
7585  1589 42            	mul	x,a
7586  158a 7b06          	ld	a,(OFST+6,sp)
7587  158c e779          	ld	(_can_out_buff+3,x),a
7588                     ; 1549 can_out_buff[can_buff_wr_ptr][4]=data2;
7590  158e b675          	ld	a,_can_buff_wr_ptr
7591  1590 97            	ld	xl,a
7592  1591 a610          	ld	a,#16
7593  1593 42            	mul	x,a
7594  1594 7b07          	ld	a,(OFST+7,sp)
7595  1596 e77a          	ld	(_can_out_buff+4,x),a
7596                     ; 1550 can_out_buff[can_buff_wr_ptr][5]=data3;
7598  1598 b675          	ld	a,_can_buff_wr_ptr
7599  159a 97            	ld	xl,a
7600  159b a610          	ld	a,#16
7601  159d 42            	mul	x,a
7602  159e 7b08          	ld	a,(OFST+8,sp)
7603  15a0 e77b          	ld	(_can_out_buff+5,x),a
7604                     ; 1551 can_out_buff[can_buff_wr_ptr][6]=data4;
7606  15a2 b675          	ld	a,_can_buff_wr_ptr
7607  15a4 97            	ld	xl,a
7608  15a5 a610          	ld	a,#16
7609  15a7 42            	mul	x,a
7610  15a8 7b09          	ld	a,(OFST+9,sp)
7611  15aa e77c          	ld	(_can_out_buff+6,x),a
7612                     ; 1552 can_out_buff[can_buff_wr_ptr][7]=data5;
7614  15ac b675          	ld	a,_can_buff_wr_ptr
7615  15ae 97            	ld	xl,a
7616  15af a610          	ld	a,#16
7617  15b1 42            	mul	x,a
7618  15b2 7b0a          	ld	a,(OFST+10,sp)
7619  15b4 e77d          	ld	(_can_out_buff+7,x),a
7620                     ; 1553 can_out_buff[can_buff_wr_ptr][8]=data6;
7622  15b6 b675          	ld	a,_can_buff_wr_ptr
7623  15b8 97            	ld	xl,a
7624  15b9 a610          	ld	a,#16
7625  15bb 42            	mul	x,a
7626  15bc 7b0b          	ld	a,(OFST+11,sp)
7627  15be e77e          	ld	(_can_out_buff+8,x),a
7628                     ; 1554 can_out_buff[can_buff_wr_ptr][9]=data7;
7630  15c0 b675          	ld	a,_can_buff_wr_ptr
7631  15c2 97            	ld	xl,a
7632  15c3 a610          	ld	a,#16
7633  15c5 42            	mul	x,a
7634  15c6 7b0c          	ld	a,(OFST+12,sp)
7635  15c8 e77f          	ld	(_can_out_buff+9,x),a
7636                     ; 1556 can_buff_wr_ptr++;
7638  15ca 3c75          	inc	_can_buff_wr_ptr
7639                     ; 1557 if(can_buff_wr_ptr>3)can_buff_wr_ptr=0;
7641  15cc b675          	ld	a,_can_buff_wr_ptr
7642  15ce a104          	cp	a,#4
7643  15d0 2502          	jrult	L5543
7646  15d2 3f75          	clr	_can_buff_wr_ptr
7647  15d4               L5543:
7648                     ; 1558 } 
7651  15d4 85            	popw	x
7652  15d5 81            	ret
7681                     ; 1561 void can_tx_hndl(void)
7681                     ; 1562 {
7682                     	switch	.text
7683  15d6               _can_tx_hndl:
7687                     ; 1563 if(bTX_FREE)
7689  15d6 3d08          	tnz	_bTX_FREE
7690  15d8 2757          	jreq	L7643
7691                     ; 1565 	if(can_buff_rd_ptr!=can_buff_wr_ptr)
7693  15da b674          	ld	a,_can_buff_rd_ptr
7694  15dc b175          	cp	a,_can_buff_wr_ptr
7695  15de 275f          	jreq	L5743
7696                     ; 1567 		bTX_FREE=0;
7698  15e0 3f08          	clr	_bTX_FREE
7699                     ; 1569 		CAN->PSR= 0;
7701  15e2 725f5427      	clr	21543
7702                     ; 1570 		CAN->Page.TxMailbox.MDLCR=8;
7704  15e6 35085429      	mov	21545,#8
7705                     ; 1571 		CAN->Page.TxMailbox.MIDR1=can_out_buff[can_buff_rd_ptr][0];
7707  15ea b674          	ld	a,_can_buff_rd_ptr
7708  15ec 97            	ld	xl,a
7709  15ed a610          	ld	a,#16
7710  15ef 42            	mul	x,a
7711  15f0 e676          	ld	a,(_can_out_buff,x)
7712  15f2 c7542a        	ld	21546,a
7713                     ; 1572 		CAN->Page.TxMailbox.MIDR2=can_out_buff[can_buff_rd_ptr][1];
7715  15f5 b674          	ld	a,_can_buff_rd_ptr
7716  15f7 97            	ld	xl,a
7717  15f8 a610          	ld	a,#16
7718  15fa 42            	mul	x,a
7719  15fb e677          	ld	a,(_can_out_buff+1,x)
7720  15fd c7542b        	ld	21547,a
7721                     ; 1574 		memcpy(&CAN->Page.TxMailbox.MDAR1, &can_out_buff[can_buff_rd_ptr][2],8);
7723  1600 b674          	ld	a,_can_buff_rd_ptr
7724  1602 97            	ld	xl,a
7725  1603 a610          	ld	a,#16
7726  1605 42            	mul	x,a
7727  1606 01            	rrwa	x,a
7728  1607 ab78          	add	a,#_can_out_buff+2
...
7742                     ; 1576 		can_buff_rd_ptr++;
7744  161d 3c74          	inc	_can_buff_rd_ptr
7745                     ; 1577 		if(can_buff_rd_ptr>3)can_buff_rd_ptr=0;
7747  161f b674          	ld	a,_can_buff_rd_ptr
7748  1621 a104          	cp	a,#4
7749  1623 2502          	jrult	L3743
7752  1625 3f74          	clr	_can_buff_rd_ptr
7753  1627               L3743:
7754                     ; 1579 		CAN->Page.TxMailbox.MCSR|= CAN_MCSR_TXRQ;
7756  1627 72105428      	bset	21544,#0
7757                     ; 1580 		CAN->IER|=(1<<0);
7759  162b 72105425      	bset	21541,#0
7760  162f 200e          	jra	L5743
7761  1631               L7643:
7762                     ; 1585 	tx_busy_cnt++;
7764  1631 3c73          	inc	_tx_busy_cnt
7765                     ; 1586 	if(tx_busy_cnt>=100)
7767  1633 b673          	ld	a,_tx_busy_cnt
7768  1635 a164          	cp	a,#100
7769  1637 2506          	jrult	L5743
7770                     ; 1588 		tx_busy_cnt=0;
7772  1639 3f73          	clr	_tx_busy_cnt
7773                     ; 1589 		bTX_FREE=1;
7775  163b 35010008      	mov	_bTX_FREE,#1
7776  163f               L5743:
7777                     ; 1592 }
7780  163f 81            	ret
7819                     ; 1595 void net_drv(void)
7819                     ; 1596 { 
7820                     	switch	.text
7821  1640               _net_drv:
7825                     ; 1598 if(bMAIN)
...
7830  164a               L451:
7831                     ; 1600 	if(++cnt_net_drv>=7) cnt_net_drv=0; 
...
7840  1654               L3153:
7841                     ; 1602 	if(cnt_net_drv<=5) 
7843  1654 b633          	ld	a,_cnt_net_drv
7844  1656 a106          	cp	a,#6
7845  1658 244c          	jruge	L5153
7846                     ; 1604 		can_transmit(0x09e,cnt_net_drv,cnt_net_drv,GETTM,0,(char)(volum_u_main_+x[cnt_net_drv]),(char)((volum_u_main_+x[cnt_net_drv])/256),1000,1000);
...
7876                     ; 1605 		i_main_bps_cnt[cnt_net_drv]++;
7878  168e b633          	ld	a,_cnt_net_drv
7879  1690 5f            	clrw	x
7880  1691 97            	ld	xl,a
7881  1692 6c0a          	inc	(_i_main_bps_cnt,x)
7882                     ; 1606 		if(i_main_bps_cnt[cnt_net_drv]>10)i_main_flag[cnt_net_drv]=0;
...
7897  16a6               L5153:
7898                     ; 1608 	else if(cnt_net_drv==6)
7900  16a6 b633          	ld	a,_cnt_net_drv
7901  16a8 a106          	cp	a,#6
7902  16aa 2641          	jrne	L1153
7903                     ; 1610 		plazma_int[2]=pwm_u;
7905  16ac be0b          	ldw	x,_pwm_u
7906  16ae bf38          	ldw	_plazma_int+4,x
7907                     ; 1611 		can_transmit(0x18e,adress,PUTTM1,*(((char*)&I)+1),*((char*)&I),*(((char*)&Un)+1),*((char*)&Un),*(((char*)&Ui)+1),*((char*)&Ui));
...
7921                     ; 1612 		can_transmit(0x18e,adress,PUTTM2,T,0,flags,_x_,*(((char*)&plazma_int[2])+1),*((char*)&plazma_int[2]));
...
8107  1730               L5653:
8108                     ; 1659  	if(flags_tu&0b00000010) flags|=0b01000000;
...
8118  173c               L7653:
8119                     ; 1660  	else flags&=0b10111111; 
8121  173c 721d000a      	bres	_flags,#6
8122  1740               L1753:
8123                     ; 1662  	vol_u_temp=mess[10]+mess[11]*256;
8125  1740 b6d0          	ld	a,_mess+11
8126  1742 5f            	clrw	x
8127  1743 97            	ld	xl,a
8128  1744 4f            	clr	a
8129  1745 02            	rlwa	x,a
8130  1746 01            	rrwa	x,a
8131  1747 bbcf          	add	a,_mess+10
...
8138                     ; 1663  	vol_i_temp=mess[12]+mess[13]*256;  
8140  1751 b6d2          	ld	a,_mess+13
8141  1753 5f            	clrw	x
8142  1754 97            	ld	xl,a
8143  1755 4f            	clr	a
8144  1756 02            	rlwa	x,a
8145  1757 01            	rrwa	x,a
8146  1758 bbd1          	add	a,_mess+12
...
8162                     ; 1680  	rotor_int=flags_tu+(((short)flags)<<8);
...
8177                     ; 1681 	can_transmit(0x18e,adress,PUTTM1,*(((char*)&I)+1),*((char*)&I),*(((char*)&Un)+1),*((char*)&Un),*(((char*)&Ui)+1),*((char*)&Ui));
...
8191                     ; 1682 	can_transmit(0x18e,adress,PUTTM2,T,0,flags,_x_,*(((char*)&plazma_int[2])+1),*((char*)&plazma_int[2]));
...
8295                     ; 1715 	if((mess[9]&0xf0)==0x20)
8297  1831 b6ce          	ld	a,_mess+9
8298  1833 a4f0          	and	a,#240
8299  1835 a120          	cp	a,#32
8300  1837 2673          	jrne	L3163
8301                     ; 1717 		if((mess[9]&0x0f)==0x01)
8303  1839 b6ce          	ld	a,_mess+9
8304  183b a40f          	and	a,#15
8305  183d a101          	cp	a,#1
8306  183f 260d          	jrne	L5163
8307                     ; 1719 			ee_K[0][0]=adc_buff_[4];
...
8317  184e               L5163:
8318                     ; 1721 		else if((mess[9]&0x0f)==0x02)
8320  184e b6ce          	ld	a,_mess+9
...
8384  18ac               L3163:
8385                     ; 1739 	else if((mess[9]&0xf0)==0x10)
8387  18ac b6ce          	ld	a,_mess+9
8388  18ae a4f0          	and	a,#240
8389  18b0 a110          	cp	a,#16
8390  18b2 2673          	jrne	L1463
8391                     ; 1741 		if((mess[9]&0x0f)==0x01)
8393  18b4 b6ce          	ld	a,_mess+9
8394  18b6 a40f          	and	a,#15
8395  18b8 a101          	cp	a,#1
8396  18ba 260d          	jrne	L3463
8397                     ; 1743 			ee_K[1][0]=adc_buff_[1];
...
8407  18c9               L3463:
8408                     ; 1745 		else if((mess[9]&0x0f)==0x02)
8410  18c9 b6ce          	ld	a,_mess+9
...
8474  1927               L1463:
8475                     ; 1768 	else if((mess[9]&0xf0)==0x00)
8477  1927 b6ce          	ld	a,_mess+9
8478  1929 a5f0          	bcp	a,#240
8479  192b 2671          	jrne	L7663
8480                     ; 1770 		if((mess[9]&0x0f)==0x01)
8482  192d b6ce          	ld	a,_mess+9
8483  192f a40f          	and	a,#15
8484  1931 a101          	cp	a,#1
8485  1933 260d          	jrne	L1763
8486                     ; 1772 			ee_K[2][0]=adc_buff_[2];
...
8496  1942               L1763:
8497                     ; 1774 		else if((mess[9]&0x0f)==0x02)
8499  1942 b6ce          	ld	a,_mess+9
...
8563  199e               L7663:
8564                     ; 1797 	else if((mess[9]&0xf0)==0x30)
8566  199e b6ce          	ld	a,_mess+9
8567  19a0 a4f0          	and	a,#240
8568  19a2 a130          	cp	a,#48
8569  19a4 265a          	jrne	L7363
8570                     ; 1799 		if((mess[9]&0x0f)==0x02)
8572  19a6 b6ce          	ld	a,_mess+9
...
8687                     ; 1832 	if(ee_Umax!=tempSS) ee_Umax=tempSS;
...
8699  1a52 85            	popw	x
8700  1a53               L3473:
8701                     ; 1833 	tempSS=mess[11]+(mess[12]*256);
8703  1a53 b6d1          	ld	a,_mess+12
8704  1a55 5f            	clrw	x
8705  1a56 97            	ld	xl,a
8706  1a57 4f            	clr	a
8707  1a58 02            	rlwa	x,a
8708  1a59 01            	rrwa	x,a
8709  1a5a bbd0          	add	a,_mess+11
...
8716                     ; 1834 	if(ee_dU!=tempSS) ee_dU=tempSS;
...
8728  1a73 85            	popw	x
8729  1a74               L5473:
8730                     ; 1835 	if((mess[13]&0x0f)==0x5)
8732  1a74 b6d2          	ld	a,_mess+13
8733  1a76 a40f          	and	a,#15
8734  1a78 a105          	cp	a,#5
8735  1a7a 261a          	jrne	L7473
8736                     ; 1837 		if(ee_AVT_MODE!=0x55)ee_AVT_MODE=0x55;
...
8752  1a96               L7473:
8753                     ; 1839 	else if(ee_AVT_MODE==0x55)ee_AVT_MODE=0;	
...
8809                     ; 1846 	if(ee_tmax!=tempSS) ee_tmax=tempSS;
...
8821  1aef 85            	popw	x
8822  1af0               L5673:
8823                     ; 1847 	tempSS=mess[11]+(mess[12]*256);
8825  1af0 b6d1          	ld	a,_mess+12
8826  1af2 5f            	clrw	x
8827  1af3 97            	ld	xl,a
8828  1af4 4f            	clr	a
8829  1af5 02            	rlwa	x,a
8830  1af6 01            	rrwa	x,a
8831  1af7 bbd0          	add	a,_mess+11
...
8838                     ; 1848 	if(ee_tsign!=tempSS) ee_tsign=tempSS;
...
8850  1b10 85            	popw	x
8851  1b11               L7673:
8852                     ; 1851 	if(mess[8]==MEM_KF1)
8854  1b11 b6cd          	ld	a,_mess+8
8855  1b13 a126          	cp	a,#38
8856  1b15 2623          	jrne	L1773
8857                     ; 1853 		if(ee_DEVICE!=0)ee_DEVICE=0;
...
8868  1b24 85            	popw	x
8869  1b25               L3773:
8870                     ; 1854 		if(ee_TZAS!=(signed short)mess[13]) ee_TZAS=(signed short)mess[13];
8872  1b25 b6d2          	ld	a,_mess+13
8873  1b27 5f            	clrw	x
8874  1b28 97            	ld	xl,a
8875  1b29 c30014        	cpw	x,_ee_TZAS
8876  1b2c 270c          	jreq	L1773
8879  1b2e b6d2          	ld	a,_mess+13
8880  1b30 5f            	clrw	x
...
8886  1b39 85            	popw	x
8887  1b3a               L1773:
8888                     ; 1856 	if(mess[8]==MEM_KF4)	//MEM_KF4 передают УКУшки там, где нужно полное управление БПСами с УКУ, включить-выключить, короче не для ИБЭП
8890  1b3a b6cd          	ld	a,_mess+8
8891  1b3c a129          	cp	a,#41
8892  1b3e 2703          	jreq	L042
8893  1b40 cc1d27        	jp	L5253
8894  1b43               L042:
8895                     ; 1858 		if(ee_DEVICE!=1)ee_DEVICE=1;
...
8907  1b55 85            	popw	x
8908  1b56               L1004:
8909                     ; 1859 		if(ee_IMAXVENT!=(signed short)mess[13]) ee_IMAXVENT=(signed short)mess[13];
8911  1b56 b6d2          	ld	a,_mess+13
8912  1b58 5f            	clrw	x
8913  1b59 97            	ld	xl,a
8914  1b5a c30000        	cpw	x,_ee_IMAXVENT
8915  1b5d 270c          	jreq	L3004
8918  1b5f b6d2          	ld	a,_mess+13
8919  1b61 5f            	clrw	x
...
8925  1b6a 85            	popw	x
8926  1b6b               L3004:
8927                     ; 1860 			if(ee_TZAS!=3) ee_TZAS=3;
...
9021  1be6               L7104:
9022                     ; 1876 	else if((mess[10]==0x66)&&(mess[11]==0x66)) _x_--; 
9024  1be6 b6cf          	ld	a,_mess+10
9025  1be8 a166          	cp	a,#102
9026  1bea 260f          	jrne	L3204
9028  1bec b6d0          	ld	a,_mess+11
...
9038  1bfb               L3204:
9039                     ; 1877 	else if((mess[10]==0x77)&&(mess[11]==0x77)) _x_=0;
9041  1bfb b6cf          	ld	a,_mess+10
9042  1bfd a177          	cp	a,#119
9043  1bff 2609          	jrne	L1204
9045  1c01 b6d0          	ld	a,_mess+11
9046  1c03 a177          	cp	a,#119
9047  1c05 2603          	jrne	L1204
9050  1c07 5f            	clrw	x
9051  1c08 bf5f          	ldw	__x_,x
9052  1c0a               L1204:
9053                     ; 1878      gran(&_x_,-XMAX,XMAX);
...
9065  1c1e               L5104:
9066                     ; 1880 else if((mess[6]==adress)&&(mess[7]==adress)&&(mess[8]==CMND)&&(mess[9]==mess[10])&&(mess[9]==0xee))
9068  1c1e b6cb          	ld	a,_mess+6
9069  1c20 c10001        	cp	a,_adress
9070  1c23 2665          	jrne	L3304
9072  1c25 b6cc          	ld	a,_mess+7
9073  1c27 c10001        	cp	a,_adress
9074  1c2a 265e          	jrne	L3304
9076  1c2c b6cd          	ld	a,_mess+8
9077  1c2e a116          	cp	a,#22
9078  1c30 2658          	jrne	L3304
9080  1c32 b6ce          	ld	a,_mess+9
9081  1c34 b1cf          	cp	a,_mess+10
9082  1c36 2652          	jrne	L3304
9084  1c38 b6ce          	ld	a,_mess+9
...
9111  1c5c 85            	popw	x
9112                     ; 1886 	delay_ms(100);
9114  1c5d ae0064        	ldw	x,#100
9115  1c60 cd004c        	call	_delay_ms
9117                     ; 1887 	if(ee_U_AVT==tempI)can_transmit(0x18e,adress,PUTID,0xdd,0xdd,0,0,0,0);
...
9139  1c8a               L3304:
9140                     ; 1892 else if((mess[7]==PUTTM1)&&(mess[6]!=adress)&&(mess[6]>=0)&&(mess[6]<=5))
9142  1c8a b6cc          	ld	a,_mess+7
9143  1c8c a1da          	cp	a,#218
9144  1c8e 2652          	jrne	L1404
9146  1c90 b6cb          	ld	a,_mess+6
9147  1c92 c10001        	cp	a,_adress
9148  1c95 274b          	jreq	L1404
9150  1c97 b6cb          	ld	a,_mess+6
9151  1c99 a106          	cp	a,#6
9152  1c9b 2445          	jruge	L1404
9153                     ; 1894 	i_main_bps_cnt[mess[6]]=0;
9155  1c9d b6cb          	ld	a,_mess+6
9156  1c9f 5f            	clrw	x
9157  1ca0 97            	ld	xl,a
9158  1ca1 6f0a          	clr	(_i_main_bps_cnt,x)
9159                     ; 1895 	i_main_flag[mess[6]]=1;
9161  1ca3 b6cb          	ld	a,_mess+6
9162  1ca5 5f            	clrw	x
...
9195                     ; 1900      	i_main_flag[adress]=1;
...
9203  1ce2               L1404:
9204                     ; 1904 else if((mess[7]==PUTTM2)&&(mess[6]!=adress)&&(mess[6]>=0)&&(mess[6]<=5))
9206  1ce2 b6cc          	ld	a,_mess+7
9207  1ce4 a1db          	cp	a,#219
9208  1ce6 263f          	jrne	L5253
9210  1ce8 b6cb          	ld	a,_mess+6
9211  1cea c10001        	cp	a,_adress
9212  1ced 2738          	jreq	L5253
9214  1cef b6cb          	ld	a,_mess+6
9215  1cf1 a106          	cp	a,#6
9216  1cf3 2432          	jruge	L5253
9217                     ; 1906 	i_main_bps_cnt[mess[6]]=0;
9219  1cf5 b6cb          	ld	a,_mess+6
9220  1cf7 5f            	clrw	x
9221  1cf8 97            	ld	xl,a
9222  1cf9 6f0a          	clr	(_i_main_bps_cnt,x)
9223                     ; 1907 	i_main_flag[mess[6]]=1;		
9225  1cfb b6cb          	ld	a,_mess+6
9226  1cfd 5f            	clrw	x
...
9234                     ; 1910 		if(mess[9]==0)i_main_flag[i]=1;
9236  1d0a 3dce          	tnz	_mess+9
...
9262  1d27               L5253:
9263                     ; 1918 can_in_an_end:
9263                     ; 1919 bCAN_RX=0;
9265  1d27 3f09          	clr	_bCAN_RX
9266                     ; 1920 }   
9269  1d29 5b05          	addw	sp,#5
9270  1d2b 81            	ret
9293                     ; 1923 void t4_init(void){
9294                     	switch	.text
9295  1d2c               _t4_init:
9299                     ; 1924 	TIM4->PSCR = 4;
9301  1d2c 35045345      	mov	21317,#4
9302                     ; 1925 	TIM4->ARR= 77;
9304  1d30 354d5346      	mov	21318,#77
9305                     ; 1926 	TIM4->IER|= TIM4_IER_UIE;					// enable break interrupt
9307  1d34 72105341      	bset	21313,#0
9308                     ; 1928 	TIM4->CR1=(TIM4_CR1_URS | TIM4_CR1_CEN | TIM4_CR1_ARPE);	
9310  1d38 35855340      	mov	21312,#133
9311                     ; 1930 }
9314  1d3c 81            	ret
9337                     ; 1933 void t1_init(void)
9337                     ; 1934 {
9338                     	switch	.text
9339  1d3d               _t1_init:
9343                     ; 1935 TIM1->ARRH= 0x03;
9345  1d3d 35035262      	mov	21090,#3
9346                     ; 1936 TIM1->ARRL= 0xff;
9348  1d41 35ff5263      	mov	21091,#255
9349                     ; 1937 TIM1->CCR1H= 0x00;	
9351  1d45 725f5265      	clr	21093
9352                     ; 1938 TIM1->CCR1L= 0xff;
9354  1d49 35ff5266      	mov	21094,#255
9355                     ; 1939 TIM1->CCR2H= 0x00;	
9357  1d4d 725f5267      	clr	21095
9358                     ; 1940 TIM1->CCR2L= 0x00;
9360  1d51 725f5268      	clr	21096
9361                     ; 1941 TIM1->CCR3H= 0x00;	
9363  1d55 725f5269      	clr	21097
9364                     ; 1942 TIM1->CCR3L= 0x64;
9366  1d59 3564526a      	mov	21098,#100
9367                     ; 1944 TIM1->CCMR1= ((6<<4) & TIM1_CCMR_OCM) | TIM1_CCMR_OCxPE; //OC2 toggle mode, prelouded
9369  1d5d 35685258      	mov	21080,#104
9370                     ; 1945 TIM1->CCMR2= ((6<<4) & TIM1_CCMR_OCM) | TIM1_CCMR_OCxPE; //OC2 toggle mode, prelouded
9372  1d61 35685259      	mov	21081,#104
9373                     ; 1946 TIM1->CCMR3= ((6<<4) & TIM1_CCMR_OCM) | TIM1_CCMR_OCxPE; //OC2 toggle mode, prelouded
9375  1d65 3568525a      	mov	21082,#104
9376                     ; 1947 TIM1->CCER1= TIM1_CCER1_CC1E | TIM1_CCER1_CC2E ; //OC1, OC2 output pins enabled
9378  1d69 3511525c      	mov	21084,#17
9379                     ; 1948 TIM1->CCER2= TIM1_CCER2_CC3E; //OC1, OC2 output pins enabled
9381  1d6d 3501525d      	mov	21085,#1
9382                     ; 1949 TIM1->CR1=(TIM1_CR1_CEN | TIM1_CR1_ARPE);
9384  1d71 35815250      	mov	21072,#129
9385                     ; 1950 TIM1->BKR|= TIM1_BKR_AOE;
9387  1d75 721c526d      	bset	21101,#6
9388                     ; 1951 }
9391  1d79 81            	ret
9416                     ; 1955 void adc2_init(void)
9416                     ; 1956 {
9417                     	switch	.text
9418  1d7a               _adc2_init:
9422                     ; 1957 adc_plazma[0]++;
9424  1d7a beb7          	ldw	x,_adc_plazma
9425  1d7c 1c0001        	addw	x,#1
9426  1d7f bfb7          	ldw	_adc_plazma,x
9427                     ; 1981 GPIOB->DDR&=~(1<<4);
9429  1d81 72195007      	bres	20487,#4
9430                     ; 1982 GPIOB->CR1&=~(1<<4);
9432  1d85 72195008      	bres	20488,#4
9433                     ; 1983 GPIOB->CR2&=~(1<<4);
9435  1d89 72195009      	bres	20489,#4
9436                     ; 1985 GPIOB->DDR&=~(1<<5);
9438  1d8d 721b5007      	bres	20487,#5
9439                     ; 1986 GPIOB->CR1&=~(1<<5);
9441  1d91 721b5008      	bres	20488,#5
9442                     ; 1987 GPIOB->CR2&=~(1<<5);
9444  1d95 721b5009      	bres	20489,#5
9445                     ; 1989 GPIOB->DDR&=~(1<<6);
9447  1d99 721d5007      	bres	20487,#6
9448                     ; 1990 GPIOB->CR1&=~(1<<6);
9450  1d9d 721d5008      	bres	20488,#6
9451                     ; 1991 GPIOB->CR2&=~(1<<6);
9453  1da1 721d5009      	bres	20489,#6
9454                     ; 1993 GPIOB->DDR&=~(1<<7);
9456  1da5 721f5007      	bres	20487,#7
9457                     ; 1994 GPIOB->CR1&=~(1<<7);
9459  1da9 721f5008      	bres	20488,#7
9460                     ; 1995 GPIOB->CR2&=~(1<<7);
9462  1dad 721f5009      	bres	20489,#7
9463                     ; 2005 ADC2->TDRL=0xff;
9465  1db1 35ff5407      	mov	21511,#255
9466                     ; 2007 ADC2->CR2=0x08;
9468  1db5 35085402      	mov	21506,#8
9469                     ; 2008 ADC2->CR1=0x40;
9471  1db9 35405401      	mov	21505,#64
9472                     ; 2011 	ADC2->CSR=0x20+adc_ch+3;
9474  1dbd b6c4          	ld	a,_adc_ch
9475  1dbf ab23          	add	a,#35
9476  1dc1 c75400        	ld	21504,a
9477                     ; 2013 	ADC2->CR1|=1;
9479  1dc4 72105401      	bset	21505,#0
9480                     ; 2014 	ADC2->CR1|=1;
9482  1dc8 72105401      	bset	21505,#0
9483                     ; 2017 adc_plazma[1]=adc_ch;
9485  1dcc b6c4          	ld	a,_adc_ch
9486  1dce 5f            	clrw	x
9487  1dcf 97            	ld	xl,a
9488  1dd0 bfb9          	ldw	_adc_plazma+2,x
9489                     ; 2018 }
9492  1dd2 81            	ret
9526                     ; 2027 @far @interrupt void TIM4_UPD_Interrupt (void) 
9526                     ; 2028 {
9528                     	switch	.text
9529  1dd3               f_TIM4_UPD_Interrupt:
9533                     ; 2029 TIM4->SR1&=~TIM4_SR1_UIF;
9535  1dd3 72115342      	bres	21314,#0
9536                     ; 2031 if(++pwm_vent_cnt>=10)pwm_vent_cnt=0;
...
9625                     ; 2071 }
9628  1e3b 80            	iret
9653                     ; 2074 @far @interrupt void CAN_RX_Interrupt (void) 
9653                     ; 2075 {
9654                     	switch	.text
9655  1e3c               f_CAN_RX_Interrupt:
9659                     ; 2077 CAN->PSR= 7;									// page 7 - read messsage
9661  1e3c 35075427      	mov	21543,#7
9662                     ; 2079 memcpy(&mess[0], &CAN->Page.RxFIFO.MFMI, 14); // compare the message content
9664  1e40 ae000e        	ldw	x,#14
9665  1e43               L062:
9666  1e43 d65427        	ld	a,(21543,x)
9667  1e46 e7c4          	ld	(_mess-1,x),a
9668  1e48 5a            	decw	x
9669  1e49 26f8          	jrne	L062
9670                     ; 2090 bCAN_RX=1;
9672  1e4b 35010009      	mov	_bCAN_RX,#1
9673                     ; 2091 CAN->RFR|=(1<<5);
9675  1e4f 721a5424      	bset	21540,#5
9676                     ; 2093 }
9679  1e53 80            	iret
9702                     ; 2096 @far @interrupt void CAN_TX_Interrupt (void) 
9702                     ; 2097 {
9703                     	switch	.text
9704  1e54               f_CAN_TX_Interrupt:
9708                     ; 2098 if((CAN->TSR)&(1<<0))
9710  1e54 c65422        	ld	a,21538
9711  1e57 a501          	bcp	a,#1
9712  1e59 2708          	jreq	L5514
9713                     ; 2100 	bTX_FREE=1;	
9715  1e5b 35010008      	mov	_bTX_FREE,#1
9716                     ; 2102 	CAN->TSR|=(1<<0);
9718  1e5f 72105422      	bset	21538,#0
9719  1e63               L5514:
9720                     ; 2104 }
9723  1e63 80            	iret
9781                     ; 2107 @far @interrupt void ADC2_EOC_Interrupt (void) {
9782                     	switch	.text
...
9797                     ; 2112 adc_plazma[2]++;
9799  1e72 bebb          	ldw	x,_adc_plazma+4
9800  1e74 1c0001        	addw	x,#1
9801  1e77 bfbb          	ldw	_adc_plazma+4,x
9802                     ; 2119 ADC2->CSR&=~(1<<7);
9804  1e79 721f5400      	bres	21504,#7
9805                     ; 2121 temp_adc=(((signed long)(ADC2->DRH))*256)+((signed long)(ADC2->DRL));
...
9887                     ; 2150 adc_ch++;
9889  1eef 3cc4          	inc	_adc_ch
9890                     ; 2151 if(adc_ch>=5)
9892  1ef1 b6c4          	ld	a,_adc_ch
9893  1ef3 a105          	cp	a,#5
9894  1ef5 250c          	jrult	L7124
9895                     ; 2154 	adc_ch=0;
9897  1ef7 3fc4          	clr	_adc_ch
9898                     ; 2155 	adc_cnt++;
9900  1ef9 3cc3          	inc	_adc_cnt
9901                     ; 2156 	if(adc_cnt>=16)
9903  1efb b6c3          	ld	a,_adc_cnt
9904  1efd a110          	cp	a,#16
9905  1eff 2502          	jrult	L7124
9906                     ; 2158 		adc_cnt=0;
9908  1f01 3fc3          	clr	_adc_cnt
9909  1f03               L7124:
9910                     ; 2162 if((adc_cnt&0x03)==0)
9912  1f03 b6c3          	ld	a,_adc_cnt
...
9962  1f48 b6c4          	ld	a,_adc_ch
9963  1f4a 905f          	clrw	y
9964  1f4c 9097          	ld	yl,a
9965  1f4e 9058          	sllw	y
9966  1f50 90df0005      	ldw	(_adc_buff_,y),x
9967  1f54               L3224:
9968                     ; 2182 adc_plazma_short++;
9970  1f54 bec1          	ldw	x,_adc_plazma_short
9971  1f56 1c0001        	addw	x,#1
9972  1f59 bfc1          	ldw	_adc_plazma_short,x
9973                     ; 2197 }
...
10051                     	switch	.text
10052  1f6a               _main:
10056                     ; 2208 CLK->ECKR|=1;
10058  1f6a 721050c1      	bset	20673,#0
10060  1f6e               L5424:
10061                     ; 2209 while((CLK->ECKR & 2) == 0);
10063  1f6e c650c1        	ld	a,20673
10064  1f71 a502          	bcp	a,#2
10065  1f73 27f9          	jreq	L5424
10066                     ; 2210 CLK->SWCR|=2;
10068  1f75 721250c5      	bset	20677,#1
10069                     ; 2211 CLK->SWR=0xB4;
10071  1f79 35b450c4      	mov	20676,#180
10072                     ; 2213 delay_ms(200);
10074  1f7d ae00c8        	ldw	x,#200
10075  1f80 cd004c        	call	_delay_ms
10077                     ; 2214 FLASH_DUKR=0xae;
10079  1f83 35ae5064      	mov	_FLASH_DUKR,#174
10080                     ; 2215 FLASH_DUKR=0x56;
10082  1f87 35565064      	mov	_FLASH_DUKR,#86
10083                     ; 2216 enableInterrupts();
10086  1f8b 9a            rim
10088                     ; 2218 delay_ms(100);
10091  1f8c ae0064        	ldw	x,#100
10092  1f8f cd004c        	call	_delay_ms
10094                     ; 2219 delay_ms(100);
10096  1f92 ae0064        	ldw	x,#100
10097  1f95 cd004c        	call	_delay_ms
10099                     ; 2220 delay_ms(100);
10101  1f98 ae0064        	ldw	x,#100
10102  1f9b cd004c        	call	_delay_ms
10104                     ; 2221 delay_ms(100);
10106  1f9e ae0064        	ldw	x,#100
10107  1fa1 cd004c        	call	_delay_ms
10109                     ; 2222 delay_ms(100);
10111  1fa4 ae0064        	ldw	x,#100
10112  1fa7 cd004c        	call	_delay_ms
10114                     ; 2224 adr_drv_v4();
10116  1faa cd121c        	call	_adr_drv_v4
10118                     ; 2228 t4_init();
10120  1fad cd1d2c        	call	_t4_init
10122                     ; 2230 		GPIOG->DDR|=(1<<0);
10124  1fb0 72105020      	bset	20512,#0
10125                     ; 2231 		GPIOG->CR1|=(1<<0);
10127  1fb4 72105021      	bset	20513,#0
10128                     ; 2232 		GPIOG->CR2&=~(1<<0);	
10130  1fb8 72115022      	bres	20514,#0
10131                     ; 2235 		GPIOG->DDR&=~(1<<1);
10133  1fbc 72135020      	bres	20512,#1
10134                     ; 2236 		GPIOG->CR1|=(1<<1);
10136  1fc0 72125021      	bset	20513,#1
10137                     ; 2237 		GPIOG->CR2&=~(1<<1);
10139  1fc4 72135022      	bres	20514,#1
10140                     ; 2239 init_CAN();
10142  1fc8 cd14e3        	call	_init_CAN
10144                     ; 2244 GPIOC->DDR|=(1<<1);
10146  1fcb 7212500c      	bset	20492,#1
10147                     ; 2245 GPIOC->CR1|=(1<<1);
10149  1fcf 7212500d      	bset	20493,#1
10150                     ; 2246 GPIOC->CR2|=(1<<1);
10152  1fd3 7212500e      	bset	20494,#1
10153                     ; 2248 GPIOC->DDR|=(1<<2);
10155  1fd7 7214500c      	bset	20492,#2
10156                     ; 2249 GPIOC->CR1|=(1<<2);
10158  1fdb 7214500d      	bset	20493,#2
10159                     ; 2250 GPIOC->CR2|=(1<<2);
10161  1fdf 7214500e      	bset	20494,#2
10162                     ; 2257 t1_init();
10164  1fe3 cd1d3d        	call	_t1_init
10166                     ; 2259 GPIOA->DDR|=(1<<5);
10168  1fe6 721a5002      	bset	20482,#5
10169                     ; 2260 GPIOA->CR1|=(1<<5);
10171  1fea 721a5003      	bset	20483,#5
10172                     ; 2261 GPIOA->CR2&=~(1<<5);
10174  1fee 721b5004      	bres	20484,#5
10175                     ; 2267 GPIOB->DDR|=(1<<3);
10177  1ff2 72165007      	bset	20487,#3
10178                     ; 2268 GPIOB->CR1|=(1<<3);
10180  1ff6 72165008      	bset	20488,#3
10181                     ; 2269 GPIOB->CR2|=(1<<3);
10183  1ffa 72165009      	bset	20489,#3
10184                     ; 2271 GPIOC->DDR|=(1<<3);
10186  1ffe 7216500c      	bset	20492,#3
10187                     ; 2272 GPIOC->CR1|=(1<<3);
10189  2002 7216500d      	bset	20493,#3
10190                     ; 2273 GPIOC->CR2|=(1<<3);
10192  2006 7216500e      	bset	20494,#3
10193                     ; 2276 if(bps_class==bpsIPS) 
10195  200a b605          	ld	a,_bps_class
10196  200c a101          	cp	a,#1
10197  200e 260a          	jrne	L3524
10198                     ; 2278 	pwm_u=ee_U_AVT;
10200  2010 ce000a        	ldw	x,_ee_U_AVT
10201  2013 bf0b          	ldw	_pwm_u,x
10202                     ; 2279 	volum_u_main_=ee_U_AVT;
10204  2015 ce000a        	ldw	x,_ee_U_AVT
10205  2018 bf1c          	ldw	_volum_u_main_,x
10206  201a               L3524:
10207                     ; 2287 	if(bCAN_RX)
10209  201a 3d09          	tnz	_bCAN_RX
10210  201c 2705          	jreq	L7524
10211                     ; 2289 		bCAN_RX=0;
10213  201e 3f09          	clr	_bCAN_RX
10214                     ; 2290 		can_in_an();	
10216  2020 cd16ee        	call	_can_in_an
10218  2023               L7524:
10219                     ; 2292 	if(b100Hz)
10221                     	btst	_b100Hz
10222  2028 240a          	jruge	L1624
10223                     ; 2294 		b100Hz=0;
10225  202a 72110008      	bres	_b100Hz
10226                     ; 2303 		adc2_init();
10228  202e cd1d7a        	call	_adc2_init
10230                     ; 2304 		can_tx_hndl();
10232  2031 cd15d6        	call	_can_tx_hndl
10234  2034               L1624:
10235                     ; 2307 	if(b10Hz)
10237                     	btst	_b10Hz
10238  2039 2419          	jruge	L3624
10239                     ; 2309 		b10Hz=0;
10241  203b 72110007      	bres	_b10Hz
10242                     ; 2311           matemat();
10244  203f cd0bca        	call	_matemat
10246                     ; 2312 	    	led_drv(); 
10248  2042 cd0711        	call	_led_drv
10250                     ; 2313 	     link_drv();
10252  2045 cd07ff        	call	_link_drv
10254                     ; 2314 	     pwr_hndl();		//вычисление воздействий на силу
10256  2048 cd0aae        	call	_pwr_hndl
10258                     ; 2315 	     JP_drv();
10260  204b cd0774        	call	_JP_drv
10262                     ; 2316 	     flags_drv();
10264  204e cd0fc8        	call	_flags_drv
10266                     ; 2317 		net_drv();
10268  2051 cd1640        	call	_net_drv
10270  2054               L3624:
10271                     ; 2320 	if(b5Hz)
10273                     	btst	_b5Hz
10274  2059 240d          	jruge	L5624
10275                     ; 2322 		b5Hz=0;
10277  205b 72110006      	bres	_b5Hz
10278                     ; 2324 		pwr_drv();		//воздействие на силу
10280  205f cd09aa        	call	_pwr_drv
10282                     ; 2325 		led_hndl();
10284  2062 cd008e        	call	_led_hndl
10286                     ; 2327 		vent_drv();
10288  2065 cd084e        	call	_vent_drv
10290  2068               L5624:
10291                     ; 2330 	if(b2Hz)
10293                     	btst	_b2Hz
10294  206d 2404          	jruge	L7624
10295                     ; 2332 		b2Hz=0;
10297  206f 72110005      	bres	_b2Hz
10298  2073               L7624:
10299                     ; 2341 	if(b1Hz)
10301                     	btst	_b1Hz
10302  2078 24a0          	jruge	L3524
10303                     ; 2343 		b1Hz=0;
10305  207a 72110004      	bres	_b1Hz
10306                     ; 2345 		temper_drv();			//вычисление аварий температуры
10308  207e cd0cf8        	call	_temper_drv
10310                     ; 2346 		u_drv();
10312  2081 cd0dcf        	call	_u_drv
10314                     ; 2347           x_drv();
10316  2084 cd0eaf        	call	_x_drv
10318                     ; 2348           if(main_cnt<1000)main_cnt++;
10320  2087 9c            	rvf
10321  2088 be52          	ldw	x,_main_cnt
10322  208a a303e8        	cpw	x,#1000
10323  208d 2e07          	jrsge	L3724
10326  208f be52          	ldw	x,_main_cnt
10327  2091 1c0001        	addw	x,#1
10328  2094 bf52          	ldw	_main_cnt,x
10329  2096               L3724:
10330                     ; 2349   		if((link==OFF)||(jp_mode==jp3))apv_hndl();
10332  2096 b663          	ld	a,_link
10333  2098 a1aa          	cp	a,#170
10334  209a 2706          	jreq	L7724
10336  209c b64b          	ld	a,_jp_mode
10337  209e a103          	cp	a,#3
10338  20a0 2603          	jrne	L5724
10339  20a2               L7724:
10342  20a2 cd0f29        	call	_apv_hndl
10344  20a5               L5724:
10345                     ; 2352   		can_error_cnt++;
10347  20a5 3c72          	inc	_can_error_cnt
10348                     ; 2353   		if(can_error_cnt>=10)
10350  20a7 b672          	ld	a,_can_error_cnt
10351  20a9 a10a          	cp	a,#10
10352  20ab 2505          	jrult	L1034
10353                     ; 2355   			can_error_cnt=0;
10355  20ad 3f72          	clr	_can_error_cnt
10356                     ; 2356 			init_CAN();
10358  20af cd14e3        	call	_init_CAN
10360  20b2               L1034:
10361                     ; 2359 		CAN->PSR= 6;									// set page 6
10363  20b2 35065427      	mov	21543,#6
10364                     ; 2360 		if((CAN->Page.Config.ESR)&0x01)
10366  20b6 c65428        	ld	a,21544
10367  20b9 a501          	bcp	a,#1
10368  20bb 270f          	jreq	L3034
10369                     ; 2362 			can1_error_cnt++;
10371  20bd 3c71          	inc	_can1_error_cnt
10372                     ; 2363 			if(can1_error_cnt>=10)
10374  20bf b671          	ld	a,_can1_error_cnt
10375  20c1 a10a          	cp	a,#10
10376  20c3 2509          	jrult	L7034
10377                     ; 2365 				can1_error_cnt=0;
10379  20c5 3f71          	clr	_can1_error_cnt
10380                     ; 2366 				init_CAN();
10382  20c7 cd14e3        	call	_init_CAN
10384  20ca 2002          	jra	L7034
10385  20cc               L3034:
10386                     ; 2370 		else can1_error_cnt=0;
10388  20cc 3f71          	clr	_can1_error_cnt
10389  20ce               L7034:
10390                     ; 2372 		volum_u_main_drv();
10392  20ce cd1390        	call	_volum_u_main_drv
10394                     ; 2374 		pwm_stat++;
10396  20d1 3c08          	inc	_pwm_stat
10397                     ; 2375 		if(pwm_stat>=10)pwm_stat=0;
10399  20d3 b608          	ld	a,_pwm_stat
10400  20d5 a10a          	cp	a,#10
10401  20d7 2502          	jrult	L1134
10404  20d9 3f08          	clr	_pwm_stat
10405  20db               L1134:
10406                     ; 2376 adc_plazma_short++;
10408  20db bec1          	ldw	x,_adc_plazma_short
10409  20dd 1c0001        	addw	x,#1
10410  20e0 bfc1          	ldw	_adc_plazma_short,x
10411  20e2 ac1a201a      	jpf	L3524
11444                     	xdef	_main
11445                     	xdef	f_ADC2_EOC_Interrupt
11446                     	xdef	f_CAN_TX_Interrupt
11447                     	xdef	f_CAN_RX_Interrupt
11448                     	xdef	f_TIM4_UPD_Interrupt
11449                     	xdef	_adc2_init
11450                     	xdef	_t1_init
11451                     	xdef	_t4_init
11452                     	xdef	_can_in_an
11453                     	xdef	_net_drv
11454                     	xdef	_can_tx_hndl
11455                     	xdef	_can_transmit
11456                     	xdef	_init_CAN
11457                     	xdef	_volum_u_main_drv
11458                     	xdef	_adr_drv_v4
11459                     	xdef	_adr_drv_v3
11460                     	xdef	_adr_gran
11461                     	xdef	_flags_drv
11462                     	xdef	_apv_hndl
11463                     	xdef	_apv_stop
11464                     	xdef	_apv_start
11465                     	xdef	_x_drv
11466                     	xdef	_u_drv
11467                     	xdef	_temper_drv
11468                     	xdef	_matemat
11469                     	xdef	_pwr_hndl
11470                     	xdef	_pwr_drv
11471                     	xdef	_vent_drv
11472                     	xdef	_link_drv
11473                     	xdef	_JP_drv
11474                     	xdef	_led_drv
11475                     	xdef	_led_hndl
11476                     	xdef	_delay_ms
11477                     	xdef	_granee
11478                     	xdef	_gran
11479                     	switch	.ubsct
11480  0001               _plazma_adress:
11481  0001 00000000      	ds.b	4
11482                     	xdef	_plazma_adress
11483                     .eeprom:	section	.data
11484  0000               _ee_IMAXVENT:
11485  0000 0000          	ds.b	2
11486                     	xdef	_ee_IMAXVENT
11487                     	switch	.ubsct
11488  0005               _bps_class:
11489  0005 00            	ds.b	1
11490                     	xdef	_bps_class
11491  0006               _vent_pwm:
11492  0006 0000          	ds.b	2
11493                     	xdef	_vent_pwm
11494  0008               _pwm_stat:
11495  0008 00            	ds.b	1
11496                     	xdef	_pwm_stat
11497  0009               _pwm_vent_cnt:
11498  0009 00            	ds.b	1
11499                     	xdef	_pwm_vent_cnt
11500                     	switch	.eeprom
11501  0002               _ee_DEVICE:
11502  0002 0000          	ds.b	2
11503                     	xdef	_ee_DEVICE
11504  0004               _ee_AVT_MODE:
11505  0004 0000          	ds.b	2
11506                     	xdef	_ee_AVT_MODE
11507                     	switch	.ubsct
11508  000a               _i_main_bps_cnt:
11509  000a 000000000000  	ds.b	6
11510                     	xdef	_i_main_bps_cnt
11511  0010               _i_main_sigma:
11512  0010 0000          	ds.b	2
11513                     	xdef	_i_main_sigma
11514  0012               _i_main_num_of_bps:
11515  0012 00            	ds.b	1
11516                     	xdef	_i_main_num_of_bps
11517  0013               _i_main_avg:
11518  0013 0000          	ds.b	2
11519                     	xdef	_i_main_avg
11520  0015               _i_main_flag:
11521  0015 000000000000  	ds.b	6
11522                     	xdef	_i_main_flag
11523  001b               _i_main:
11524  001b 000000000000  	ds.b	12
11525                     	xdef	_i_main
11526  0027               _x:
11527  0027 000000000000  	ds.b	12
11528                     	xdef	_x
11529                     	xdef	_volum_u_main_
11530                     	switch	.eeprom
11531  0006               _UU_AVT:
11532  0006 0000          	ds.b	2
11533                     	xdef	_UU_AVT
11534                     	switch	.ubsct
11535  0033               _cnt_net_drv:
11536  0033 00            	ds.b	1
11537                     	xdef	_cnt_net_drv
11538                     	switch	.bit
11539  0001               _bMAIN:
11540  0001 00            	ds.b	1
11541                     	xdef	_bMAIN
11542                     	switch	.ubsct
11543  0034               _plazma_int:
11544  0034 000000000000  	ds.b	6
11545                     	xdef	_plazma_int
11546                     	xdef	_rotor_int
11547  003a               _led_green_buff:
11548  003a 00000000      	ds.b	4
11549                     	xdef	_led_green_buff
11550  003e               _led_red_buff:
11551  003e 00000000      	ds.b	4
11552                     	xdef	_led_red_buff
11553                     	xdef	_led_drv_cnt
11554                     	xdef	_led_green
11555                     	xdef	_led_red
11556  0042               _res_fl_cnt:
11557  0042 00            	ds.b	1
11558                     	xdef	_res_fl_cnt
11559                     	xdef	_bRES_
11560                     	xdef	_bRES
11561                     	switch	.eeprom
11562  0008               _res_fl_:
11563  0008 00            	ds.b	1
11564                     	xdef	_res_fl_
11565  0009               _res_fl:
11566  0009 00            	ds.b	1
11567                     	xdef	_res_fl
11568                     	switch	.ubsct
11569  0043               _cnt_apv_off:
11570  0043 00            	ds.b	1
11571                     	xdef	_cnt_apv_off
11572                     	switch	.bit
11573  0002               _bAPV:
11574  0002 00            	ds.b	1
11575                     	xdef	_bAPV
11576                     	switch	.ubsct
11577  0044               _apv_cnt_:
11578  0044 0000          	ds.b	2
11579                     	xdef	_apv_cnt_
11580  0046               _apv_cnt:
11581  0046 000000        	ds.b	3
11582                     	xdef	_apv_cnt
11583                     	xdef	_bBL_IPS
11584                     	switch	.bit
11585  0003               _bBL:
11586  0003 00            	ds.b	1
11587                     	xdef	_bBL
11588                     	switch	.ubsct
11589  0049               _cnt_JP1:
11590  0049 00            	ds.b	1
11591                     	xdef	_cnt_JP1
11592  004a               _cnt_JP0:
11593  004a 00            	ds.b	1
11594                     	xdef	_cnt_JP0
11595  004b               _jp_mode:
11596  004b 00            	ds.b	1
11597                     	xdef	_jp_mode
11598                     	xdef	_pwm_i
11599                     	xdef	_pwm_u
11600  004c               _tmax_cnt:
11601  004c 0000          	ds.b	2
11602                     	xdef	_tmax_cnt
11603  004e               _tsign_cnt:
11604  004e 0000          	ds.b	2
11605                     	xdef	_tsign_cnt
11606                     	switch	.eeprom
11607  000a               _ee_U_AVT:
11608  000a 0000          	ds.b	2
11609                     	xdef	_ee_U_AVT
11610  000c               _ee_tsign:
11611  000c 0000          	ds.b	2
11612                     	xdef	_ee_tsign
11613  000e               _ee_tmax:
11614  000e 0000          	ds.b	2
11615                     	xdef	_ee_tmax
11616  0010               _ee_dU:
11617  0010 0000          	ds.b	2
11618                     	xdef	_ee_dU
11619  0012               _ee_Umax:
11620  0012 0000          	ds.b	2
11621                     	xdef	_ee_Umax
11622  0014               _ee_TZAS:
11623  0014 0000          	ds.b	2
11624                     	xdef	_ee_TZAS
11625                     	switch	.ubsct
11626  0050               _main_cnt1:
11627  0050 0000          	ds.b	2
11628                     	xdef	_main_cnt1
11629  0052               _main_cnt:
11630  0052 0000          	ds.b	2
11631                     	xdef	_main_cnt
11632  0054               _off_bp_cnt:
11633  0054 00            	ds.b	1
11634                     	xdef	_off_bp_cnt
11635  0055               _flags_tu_cnt_off:
11636  0055 00            	ds.b	1
11637                     	xdef	_flags_tu_cnt_off
11638  0056               _flags_tu_cnt_on:
11639  0056 00            	ds.b	1
11640                     	xdef	_flags_tu_cnt_on
11641  0057               _vol_i_temp:
11642  0057 0000          	ds.b	2
11643                     	xdef	_vol_i_temp
11644  0059               _vol_u_temp:
11645  0059 0000          	ds.b	2
11646                     	xdef	_vol_u_temp
11647                     	switch	.eeprom
11648  0016               __x_ee_:
11649  0016 0000          	ds.b	2
11650                     	xdef	__x_ee_
11651                     	switch	.ubsct
11652  005b               __x_cnt:
11653  005b 0000          	ds.b	2
11654                     	xdef	__x_cnt
11655  005d               __x__:
11656  005d 0000          	ds.b	2
11657                     	xdef	__x__
11658  005f               __x_:
11659  005f 0000          	ds.b	2
11660                     	xdef	__x_
11661  0061               _flags_tu:
11662  0061 00            	ds.b	1
11663                     	xdef	_flags_tu
11664                     	xdef	_flags
11665  0062               _link_cnt:
11666  0062 00            	ds.b	1
11667                     	xdef	_link_cnt
11668  0063               _link:
11669  0063 00            	ds.b	1
11670                     	xdef	_link
11671  0064               _umin_cnt:
11672  0064 0000          	ds.b	2
11673                     	xdef	_umin_cnt
11674  0066               _umax_cnt:
11675  0066 0000          	ds.b	2
11676                     	xdef	_umax_cnt
11677                     	switch	.eeprom
11678  0018               _ee_K:
11679  0018 000000000000  	ds.b	16
11680                     	xdef	_ee_K
11681                     	switch	.ubsct
11682  0068               _T:
11683  0068 00            	ds.b	1
11684                     	xdef	_T
11685  0069               _Udb:
11686  0069 0000          	ds.b	2
11687                     	xdef	_Udb
11688  006b               _Ui:
11689  006b 0000          	ds.b	2
11690                     	xdef	_Ui
11691  006d               _Un:
11692  006d 0000          	ds.b	2
11693                     	xdef	_Un
11694  006f               _I:
11695  006f 0000          	ds.b	2
11696                     	xdef	_I
11697  0071               _can1_error_cnt:
11698  0071 00            	ds.b	1
11699                     	xdef	_can1_error_cnt
11700  0072               _can_error_cnt:
11701  0072 00            	ds.b	1
11702                     	xdef	_can_error_cnt
11703                     	xdef	_bCAN_RX
11704  0073               _tx_busy_cnt:
11705  0073 00            	ds.b	1
11706                     	xdef	_tx_busy_cnt
11707                     	xdef	_bTX_FREE
11708  0074               _can_buff_rd_ptr:
11709  0074 00            	ds.b	1
11710                     	xdef	_can_buff_rd_ptr
11711  0075               _can_buff_wr_ptr:
11712  0075 00            	ds.b	1
11713                     	xdef	_can_buff_wr_ptr
11714  0076               _can_out_buff:
11715  0076 000000000000  	ds.b	64
11716                     	xdef	_can_out_buff
11717                     	switch	.bss
11718  0000               _adress_error:
11719  0000 00            	ds.b	1
11720                     	xdef	_adress_error
11721  0001               _adress:
11722  0001 00            	ds.b	1
11723                     	xdef	_adress
11724  0002               _adr:
11725  0002 000000        	ds.b	3
11726                     	xdef	_adr
11727                     	xdef	_adr_drv_stat
11728                     	xdef	_led_ind
11729                     	switch	.ubsct
11730  00b6               _led_ind_cnt:
11731  00b6 00            	ds.b	1
11732                     	xdef	_led_ind_cnt
11733  00b7               _adc_plazma:
11734  00b7 000000000000  	ds.b	10
11735                     	xdef	_adc_plazma
11736  00c1               _adc_plazma_short:
11737  00c1 0000          	ds.b	2
11738                     	xdef	_adc_plazma_short
11739  00c3               _adc_cnt:
11740  00c3 00            	ds.b	1
11741                     	xdef	_adc_cnt
11742  00c4               _adc_ch:
11743  00c4 00            	ds.b	1
11744                     	xdef	_adc_ch
11745                     	switch	.bss
11746  0005               _adc_buff_:
11747  0005 000000000000  	ds.b	20
11748                     	xdef	_adc_buff_
11749  0019               _adc_buff:
11750  0019 000000000000  	ds.b	320
11751                     	xdef	_adc_buff
11752                     	switch	.ubsct
11753  00c5               _mess:
11754  00c5 000000000000  	ds.b	14
11755                     	xdef	_mess
11756                     	switch	.bit
11757  0004               _b1Hz:
11758  0004 00            	ds.b	1
11759                     	xdef	_b1Hz
11760  0005               _b2Hz:
11761  0005 00            	ds.b	1
11762                     	xdef	_b2Hz
11763  0006               _b5Hz:
11764  0006 00            	ds.b	1
11765                     	xdef	_b5Hz
11766  0007               _b10Hz:
11767  0007 00            	ds.b	1
11768                     	xdef	_b10Hz
11769  0008               _b100Hz:
11770  0008 00            	ds.b	1
11771                     	xdef	_b100Hz
11772                     	xdef	_t0_cnt4
11773                     	xdef	_t0_cnt3
11774                     	xdef	_t0_cnt2
