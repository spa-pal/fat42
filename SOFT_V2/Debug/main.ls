...
6135                     ; 1111 } 
6138  1009 81            	ret
6172                     ; 1250 char adr_gran(signed short in)
6172                     ; 1251 {
6173                     	switch	.text
6174  100a               _adr_gran:
6176  100a 89            	pushw	x
6177       00000000      OFST:	set	0
6180                     ; 1252 if(in>800)return 1;
6182  100b 9c            	rvf
...
6190  1015               L7103:
6191                     ; 1253 else if((in>60)&&(in<140))return 0;
6193  1015 9c            	rvf
...
6370  10c3               L1603:
6371                     ; 1301 else if((adc_buff_[0]>=(ADR_CONST_1-20))&&(adc_buff_[0]<=(ADR_CONST_1+20))) adr[0]=1;
6373  10c3 9c            	rvf
...
6387  10db               L5603:
6388                     ; 1302 else if((adc_buff_[0]>=(ADR_CONST_2-20))&&(adc_buff_[0]<=(ADR_CONST_2+20))) adr[0]=2;
6390  10db 9c            	rvf
...
6404  10f3               L1703:
6405                     ; 1303 else if((adc_buff_[0]>=(ADR_CONST_3-20))&&(adc_buff_[0]<=(ADR_CONST_3+20))) adr[0]=3;
6407  10f3 9c            	rvf
...
6421  110b               L5703:
6422                     ; 1304 else adr[0]=5;
6424  110b 35050002      	mov	_adr,#5
6425  110f               L3603:
6426                     ; 1306 if((adc_buff_[1]>=(ADR_CONST_0-20))&&(adc_buff_[1]<=(ADR_CONST_0+20))) adr[1]=0;
6428  110f 9c            	rvf
...
6442  1127               L1013:
6443                     ; 1307 else if((adc_buff_[1]>=(ADR_CONST_1-20))&&(adc_buff_[1]<=(ADR_CONST_1+20))) adr[1]=1;
6445  1127 9c            	rvf
...
6459  113f               L5013:
6460                     ; 1308 else if((adc_buff_[1]>=(ADR_CONST_2-20))&&(adc_buff_[1]<=(ADR_CONST_2+20))) adr[1]=2;
6462  113f 9c            	rvf
...
6476  1157               L1113:
6477                     ; 1309 else if((adc_buff_[1]>=(ADR_CONST_3-20))&&(adc_buff_[1]<=(ADR_CONST_3+20))) adr[1]=3;
6479  1157 9c            	rvf
...
6493  116f               L5113:
6494                     ; 1310 else adr[1]=5;
6496  116f 35050003      	mov	_adr+1,#5
6497  1173               L3013:
6498                     ; 1312 if((adc_buff_[9]>=(ADR_CONST_0-20))&&(adc_buff_[9]<=(ADR_CONST_0+20))) adr[2]=0;
6500  1173 9c            	rvf
...
6514  118b               L1213:
6515                     ; 1313 else if((adc_buff_[9]>=(ADR_CONST_1-20))&&(adc_buff_[9]<=(ADR_CONST_1+20))) adr[2]=1;
6517  118b 9c            	rvf
...
6531  11a3               L5213:
6532                     ; 1314 else if((adc_buff_[9]>=(ADR_CONST_2-20))&&(adc_buff_[9]<=(ADR_CONST_2+20))) adr[2]=2;
6534  11a3 9c            	rvf
...
6548  11bb               L1313:
6549                     ; 1315 else if((adc_buff_[9]>=(ADR_CONST_3-20))&&(adc_buff_[9]<=(ADR_CONST_3+20))) adr[2]=3;
6551  11bb 9c            	rvf
...
6565  11d3               L5313:
6566                     ; 1316 else adr[2]=5;
6568  11d3 35050004      	mov	_adr+2,#5
6569  11d7               L3213:
6570                     ; 1320 if((adr[0]==5)||(adr[1]==5)||(adr[2]==5))
...
6593  11f1 81            	ret
6594  11f2               L1413:
6595                     ; 1327 	if(adr[2]&0x02) bps_class=bpsIPS;
...
6605  11ff               L1513:
6606                     ; 1328 	else bps_class=bpsIBEP;
6608  11ff 3f01          	clr	_bps_class
6609  1201               L3513:
6610                     ; 1330 	adress = adr[0] + (adr[1]*4) + ((adr[2]&0x01)*16);
...
6961  1377               L7423:
6962                     ; 1417 else adress=100;
6964  1377 35640001      	mov	_adress,#100
6965  137b               L5423:
6966                     ; 1419 }
6969  137b 5b09          	addw	sp,#9
6970  137d 81            	ret
7014                     ; 1423 void volum_u_main_drv(void)
7014                     ; 1424 {
7015                     	switch	.text
...
7027  1389               L431:
7028                     ; 1429 	if(Un<(UU_AVT-10))volum_u_main_+=5;
7030  1389 9c            	rvf
...
7042  139d               L3723:
7043                     ; 1430 	else if(Un<(UU_AVT-1))volum_u_main_++;
7045  139d 9c            	rvf
...
7057  13af               L7723:
7058                     ; 1431 	else if(Un>(UU_AVT+10))volum_u_main_-=10;
7060  13af 9c            	rvf
...
7072  13c3               L3033:
7073                     ; 1432 	else if(Un>(UU_AVT+1))volum_u_main_--;
7075  13c3 9c            	rvf
...
7085  13d3               L5723:
7086                     ; 1433 	if(volum_u_main_>1020)volum_u_main_=1020;
7088  13d3 9c            	rvf
...
7096  13e0               L1133:
7097                     ; 1434 	if(volum_u_main_<0)volum_u_main_=0;
7099  13e0 9c            	rvf
...
7208  1463               L7333:
7209                     ; 1458 			else if(i_main[i]>(i_main_avg+10))x[i]--;
7211  1463 9c            	rvf
...
7286  14cf 84            	pop	a
7287  14d0 81            	ret
7310                     ; 1470 void init_CAN(void) {
7311                     	switch	.text
7312  14d1               _init_CAN:
7316                     ; 1471 	CAN->MCR&=~CAN_MCR_SLEEP;					// CAN wake up request
7318  14d1 72135420      	bres	21536,#1
7319                     ; 1472 	CAN->MCR|= CAN_MCR_INRQ;					// CAN initialization request
7321  14d5 72105420      	bset	21536,#0
7323  14d9               L3633:
7324                     ; 1473 	while((CAN->MSR & CAN_MSR_INAK) == 0);	// waiting for CAN enter the init mode
7326  14d9 c65421        	ld	a,21537
7327  14dc a501          	bcp	a,#1
7328  14de 27f9          	jreq	L3633
7329                     ; 1475 	CAN->MCR|= CAN_MCR_NART;					// no automatic retransmition
7331  14e0 72185420      	bset	21536,#4
7332                     ; 1477 	CAN->PSR= 2;							// *** FILTER 0 SETTINGS ***
7334  14e4 35025427      	mov	21543,#2
7335                     ; 1486 	CAN->Page.Filter01.F0R1= UKU_MESS_STID>>3;			// 16 bits mode
7337  14e8 35135428      	mov	21544,#19
7338                     ; 1487 	CAN->Page.Filter01.F0R2= UKU_MESS_STID<<5;
7340  14ec 35c05429      	mov	21545,#192
7341                     ; 1488 	CAN->Page.Filter01.F0R5= UKU_MESS_STID_MASK>>3;
7343  14f0 357f542c      	mov	21548,#127
7344                     ; 1489 	CAN->Page.Filter01.F0R6= UKU_MESS_STID_MASK<<5;
7346  14f4 35e0542d      	mov	21549,#224
7347                     ; 1491 	CAN->Page.Filter01.F1R1= BPS_MESS_STID>>3;			// 16 bits mode
7349  14f8 35315430      	mov	21552,#49
7350                     ; 1492 	CAN->Page.Filter01.F1R2= BPS_MESS_STID<<5;
7352  14fc 35c05431      	mov	21553,#192
7353                     ; 1493 	CAN->Page.Filter01.F1R5= BPS_MESS_STID_MASK>>3;
7355  1500 357f5434      	mov	21556,#127
7356                     ; 1494 	CAN->Page.Filter01.F1R6= BPS_MESS_STID_MASK<<5;
7358  1504 35e05435      	mov	21557,#224
7359                     ; 1498 	CAN->PSR= 6;									// set page 6
7361  1508 35065427      	mov	21543,#6
7362                     ; 1503 	CAN->Page.Config.FMR1&=~3;								//mask mode
7364  150c c65430        	ld	a,21552
7365  150f a4fc          	and	a,#252
7366  1511 c75430        	ld	21552,a
7367                     ; 1509 	CAN->Page.Config.FCR1= ((3<<1) & (CAN_FCR1_FSC00 | CAN_FCR1_FSC01));		//16 bit scale
7369  1514 35065432      	mov	21554,#6
7370                     ; 1510 	CAN->Page.Config.FCR1= ((3<<5) & (CAN_FCR1_FSC10 | CAN_FCR1_FSC11));		//16 bit scale
7372  1518 35605432      	mov	21554,#96
7373                     ; 1513 	CAN->Page.Config.FCR1|= CAN_FCR1_FACT0;	// filter 0 active
7375  151c 72105432      	bset	21554,#0
7376                     ; 1514 	CAN->Page.Config.FCR1|= CAN_FCR1_FACT1;
7378  1520 72185432      	bset	21554,#4
7379                     ; 1517 	CAN->PSR= 6;								// *** BIT TIMING SETTINGS ***
7381  1524 35065427      	mov	21543,#6
7382                     ; 1519 	CAN->Page.Config.BTR1= 9;					// CAN_BTR1_BRP=9, 	tq= fcpu/(9+1)
7384  1528 3509542c      	mov	21548,#9
7385                     ; 1520 	CAN->Page.Config.BTR2= (1<<7)|(6<<4) | 7; 		// BS2=8, BS1=7, 		
7387  152c 35e7542d      	mov	21549,#231
7388                     ; 1522 	CAN->IER|=(1<<1);
7390  1530 72125425      	bset	21541,#1
7391                     ; 1525 	CAN->MCR&=~CAN_MCR_INRQ;					// leave initialization request
7393  1534 72115420      	bres	21536,#0
7395  1538               L1733:
7396                     ; 1526 	while((CAN->MSR & CAN_MSR_INAK) != 0);	// waiting for CAN leave the init mode
7398  1538 c65421        	ld	a,21537
7399  153b a501          	bcp	a,#1
7400  153d 26f9          	jrne	L1733
7401                     ; 1527 }
7404  153f 81            	ret
7512                     ; 1530 void can_transmit(unsigned short id_st,char data0,char data1,char data2,char data3,char data4,char data5,char data6,char data7)
7512                     ; 1531 {
7513                     	switch	.text
7514  1540               _can_transmit:
7516  1540 89            	pushw	x
7517       00000000      OFST:	set	0
7520                     ; 1533 if((can_buff_wr_ptr<0)||(can_buff_wr_ptr>3))can_buff_wr_ptr=0;
7522  1541 b670          	ld	a,_can_buff_wr_ptr
7523  1543 a104          	cp	a,#4
7524  1545 2502          	jrult	L3543
7527  1547 3f70          	clr	_can_buff_wr_ptr
7528  1549               L3543:
7529                     ; 1535 can_out_buff[can_buff_wr_ptr][0]=(char)(id_st>>6);
...
7543                     ; 1536 can_out_buff[can_buff_wr_ptr][1]=(char)(id_st<<2);
...
7553                     ; 1538 can_out_buff[can_buff_wr_ptr][2]=data0;
...
7561                     ; 1539 can_out_buff[can_buff_wr_ptr][3]=data1;
...
7569                     ; 1540 can_out_buff[can_buff_wr_ptr][4]=data2;
...
7577                     ; 1541 can_out_buff[can_buff_wr_ptr][5]=data3;
...
7585                     ; 1542 can_out_buff[can_buff_wr_ptr][6]=data4;
...
7593                     ; 1543 can_out_buff[can_buff_wr_ptr][7]=data5;
...
7601                     ; 1544 can_out_buff[can_buff_wr_ptr][8]=data6;
...
7609                     ; 1545 can_out_buff[can_buff_wr_ptr][9]=data7;
...
7617                     ; 1547 can_buff_wr_ptr++;
7619  15b8 3c70          	inc	_can_buff_wr_ptr
7620                     ; 1548 if(can_buff_wr_ptr>3)can_buff_wr_ptr=0;
...
7694                     ; 1563 		CAN->Page.TxMailbox.MIDR2=can_out_buff[can_buff_rd_ptr][1];
...
7702                     ; 1565 		memcpy(&CAN->Page.TxMailbox.MDAR1, &can_out_buff[can_buff_rd_ptr][2],8);
...
7811  1638               L451:
7812                     ; 1591 	if(++cnt_net_drv>=7) cnt_net_drv=0; 
...
7821  1642               L3153:
7822                     ; 1593 	if(cnt_net_drv<=5) 
7824  1642 b62f          	ld	a,_cnt_net_drv
7825  1644 a106          	cp	a,#6
7826  1646 244c          	jruge	L5153
7827                     ; 1595 		can_transmit(0x09e,cnt_net_drv,cnt_net_drv,GETTM,0,(char)(volum_u_main_+x[cnt_net_drv]),(char)((volum_u_main_+x[cnt_net_drv])/256),1000,1000);
...
7857                     ; 1596 		i_main_bps_cnt[cnt_net_drv]++;
7859  167c b62f          	ld	a,_cnt_net_drv
7860  167e 5f            	clrw	x
7861  167f 97            	ld	xl,a
7862  1680 6c06          	inc	(_i_main_bps_cnt,x)
7863                     ; 1597 		if(i_main_bps_cnt[cnt_net_drv]>10)i_main_flag[cnt_net_drv]=0;
...
7878  1694               L5153:
7879                     ; 1599 	else if(cnt_net_drv==6)
7881  1694 b62f          	ld	a,_cnt_net_drv
7882  1696 a106          	cp	a,#6
7883  1698 2641          	jrne	L1153
7884                     ; 1601 		plazma_int[2]=pwm_u;
7886  169a be0b          	ldw	x,_pwm_u
7887  169c bf34          	ldw	_plazma_int+4,x
7888                     ; 1602 		can_transmit(0x18e,adress,PUTTM1,*(((char*)&I)+1),*((char*)&I),*(((char*)&Un)+1),*((char*)&Un),*(((char*)&Ui)+1),*((char*)&Ui));
...
7902                     ; 1603 		can_transmit(0x18e,adress,PUTTM2,T,0,flags,_x_,*(((char*)&plazma_int[2])+1),*((char*)&plazma_int[2]));
...
7917                     ; 1606 }
7920  16db 81            	ret
8030                     ; 1609 void can_in_an(void)
8030                     ; 1610 {
8031                     	switch	.text
8032  16dc               _can_in_an:
8034  16dc 5205          	subw	sp,#5
8035       00000005      OFST:	set	5
8038                     ; 1620 if((mess[6]==adress)&&(mess[7]==adress)&&(mess[8]==GETTM))	
...
8088  171e               L5653:
8089                     ; 1650  	if(flags_tu&0b00000010) flags|=0b01000000;
...
8099  172a               L7653:
8100                     ; 1651  	else flags&=0b10111111; 
8102  172a 721d000a      	bres	_flags,#6
8103  172e               L1753:
8104                     ; 1653  	vol_u_temp=mess[10]+mess[11]*256;
...
8119                     ; 1654  	vol_i_temp=mess[12]+mess[13]*256;  
...
8143                     ; 1664  	rotor_int=flags_tu+(((short)flags)<<8);
...
8158                     ; 1665 	can_transmit(0x18e,adress,PUTTM1,*(((char*)&I)+1),*((char*)&I),*(((char*)&Un)+1),*((char*)&Un),*(((char*)&Ui)+1),*((char*)&Ui));
...
8172                     ; 1666 	can_transmit(0x18e,adress,PUTTM2,T,0,flags,_x_,*(((char*)&plazma_int[2])+1),*((char*)&plazma_int[2]));
...
8245  17f2               L1653:
8246                     ; 1695 else if((mess[6]==adress)&&(mess[7]==adress)&&(mess[8]==KLBR)&&(mess[9]==mess[10]))
...
8298  183c               L5163:
8299                     ; 1704 		else if((mess[9]&0x0f)==0x02)
...
8388  18b7               L3463:
8389                     ; 1728 		else if((mess[9]&0x0f)==0x02)
...
8477  1930               L1763:
8478                     ; 1757 		else if((mess[9]&0x0f)==0x02)
...
8635  1a08               L1163:
8636                     ; 1811 else if((mess[6]==0xff)&&(mess[7]==0xff)&&(mess[8]==MEM_KF))
...
8653                     ; 1814 	tempSS=mess[9]+(mess[10]*256);
...
8668                     ; 1815 	if(ee_Umax!=tempSS) ee_Umax=tempSS;
...
8680  1a40 85            	popw	x
8681  1a41               L3473:
8682                     ; 1816 	tempSS=mess[11]+(mess[12]*256);
...
8697                     ; 1817 	if(ee_dU!=tempSS) ee_dU=tempSS;
...
8733  1a84               L7473:
8734                     ; 1822 	else if(ee_AVT_MODE==0x55)ee_AVT_MODE=0;	
...
8750  1a9c               L1473:
8751                     ; 1825 else if((mess[6]==0xff)&&(mess[7]==0xff)&&((mess[8]==MEM_KF1)||(mess[8]==MEM_KF4)))
...
8773  1abd               L632:
8774  1abd               L3673:
8775                     ; 1828 	tempSS=mess[9]+(mess[10]*256);
...
8790                     ; 1829 	if(ee_tmax!=tempSS) ee_tmax=tempSS;
...
8802  1add 85            	popw	x
8803  1ade               L5673:
8804                     ; 1830 	tempSS=mess[11]+(mess[12]*256);
...
8819                     ; 1831 	if(ee_tsign!=tempSS) ee_tsign=tempSS;
...
8849  1b12 85            	popw	x
8850  1b13               L3773:
8851                     ; 1837 		if(ee_TZAS!=(signed short)mess[13]) ee_TZAS=(signed short)mess[13];
...
8867  1b27 85            	popw	x
8868  1b28               L1773:
8869                     ; 1839 	if(mess[8]==MEM_KF4)	//MEM_KF4 передают УКУшки там, где нужно полное управление БПСами с УКУ, включить-выключить, короче не для ИБЭП
8871  1b28 b6c8          	ld	a,_mess+8
8872  1b2a a129          	cp	a,#41
8873  1b2c 2703          	jreq	L042
8874  1b2e cc1d15        	jp	L5253
8875  1b31               L042:
8876                     ; 1841 		if(ee_DEVICE!=1)ee_DEVICE=1;
...
8888  1b43 85            	popw	x
8889  1b44               L1004:
8890                     ; 1842 		if(ee_IMAXVENT!=(signed short)mess[13]) ee_IMAXVENT=(signed short)mess[13];
...
8906  1b58 85            	popw	x
8907  1b59               L3004:
8908                     ; 1843 			if(ee_TZAS!=3) ee_TZAS=3;
...
8924  1b73               L1673:
8925                     ; 1847 else if((mess[6]==adress)&&(mess[7]==adress)&&(mess[8]==CMND)&&(mess[9]==ALRM_RES))
...
8986                     ; 1858 	if((mess[10]==0x55)&&(mess[11]==0x55)) _x_++;
...
9002  1bd4               L7104:
9003                     ; 1859 	else if((mess[10]==0x66)&&(mess[11]==0x66)) _x_--; 
...
9019  1be9               L3204:
9020                     ; 1860 	else if((mess[10]==0x77)&&(mess[11]==0x77)) _x_=0;
...
9046  1c0c               L5104:
9047                     ; 1863 else if((mess[6]==adress)&&(mess[7]==adress)&&(mess[8]==CMND)&&(mess[9]==mess[10])&&(mess[9]==0xee))
...
9092  1c4a 85            	popw	x
9093                     ; 1869 	delay_ms(100);
9095  1c4b ae0064        	ldw	x,#100
9096  1c4e cd004c        	call	_delay_ms
9098                     ; 1870 	if(ee_U_AVT==tempI)can_transmit(0x18e,adress,PUTID,0xdd,0xdd,0,0,0,0);
...
9120  1c78               L3304:
9121                     ; 1875 else if((mess[7]==PUTTM1)&&(mess[6]!=adress)&&(mess[6]>=0)&&(mess[6]<=5))
...
9151                     ; 1881 		i_main[mess[6]]=(signed short)mess[8]+(((signed short)mess[9])*256);
...
9176                     ; 1883      	i_main_flag[adress]=1;
...
9184  1cd0               L1404:
9185                     ; 1887 else if((mess[7]==PUTTM2)&&(mess[6]!=adress)&&(mess[6]>=0)&&(mess[6]<=5))
...
9215                     ; 1893 		if(mess[9]==0)i_main_flag[i]=1;
...
9243  1d15               L5253:
9244                     ; 1901 can_in_an_end:
9244                     ; 1902 bCAN_RX=0;
9246  1d15 3f09          	clr	_bCAN_RX
9247                     ; 1903 }   
9250  1d17 5b05          	addw	sp,#5
9251  1d19 81            	ret
9274                     ; 1906 void t4_init(void){
9275                     	switch	.text
9276  1d1a               _t4_init:
9280                     ; 1907 	TIM4->PSCR = 4;
9282  1d1a 35045345      	mov	21317,#4
9283                     ; 1908 	TIM4->ARR= 77;
9285  1d1e 354d5346      	mov	21318,#77
9286                     ; 1909 	TIM4->IER|= TIM4_IER_UIE;					// enable break interrupt
9288  1d22 72105341      	bset	21313,#0
9289                     ; 1911 	TIM4->CR1=(TIM4_CR1_URS | TIM4_CR1_CEN | TIM4_CR1_ARPE);	
9291  1d26 35855340      	mov	21312,#133
9292                     ; 1913 }
9295  1d2a 81            	ret
9318                     ; 1916 void t1_init(void)
9318                     ; 1917 {
9319                     	switch	.text
9320  1d2b               _t1_init:
9324                     ; 1918 TIM1->ARRH= 0x03;
9326  1d2b 35035262      	mov	21090,#3
9327                     ; 1919 TIM1->ARRL= 0xff;
9329  1d2f 35ff5263      	mov	21091,#255
9330                     ; 1920 TIM1->CCR1H= 0x00;	
9332  1d33 725f5265      	clr	21093
9333                     ; 1921 TIM1->CCR1L= 0xff;
9335  1d37 35ff5266      	mov	21094,#255
9336                     ; 1922 TIM1->CCR2H= 0x00;	
9338  1d3b 725f5267      	clr	21095
9339                     ; 1923 TIM1->CCR2L= 0x00;
9341  1d3f 725f5268      	clr	21096
9342                     ; 1924 TIM1->CCR3H= 0x00;	
9344  1d43 725f5269      	clr	21097
9345                     ; 1925 TIM1->CCR3L= 0x64;
9347  1d47 3564526a      	mov	21098,#100
9348                     ; 1927 TIM1->CCMR1= ((6<<4) & TIM1_CCMR_OCM) | TIM1_CCMR_OCxPE; //OC2 toggle mode, prelouded
9350  1d4b 35685258      	mov	21080,#104
9351                     ; 1928 TIM1->CCMR2= ((6<<4) & TIM1_CCMR_OCM) | TIM1_CCMR_OCxPE; //OC2 toggle mode, prelouded
9353  1d4f 35685259      	mov	21081,#104
9354                     ; 1929 TIM1->CCMR3= ((6<<4) & TIM1_CCMR_OCM) | TIM1_CCMR_OCxPE; //OC2 toggle mode, prelouded
9356  1d53 3568525a      	mov	21082,#104
9357                     ; 1930 TIM1->CCER1= TIM1_CCER1_CC1E | TIM1_CCER1_CC2E ; //OC1, OC2 output pins enabled
9359  1d57 3511525c      	mov	21084,#17
9360                     ; 1931 TIM1->CCER2= TIM1_CCER2_CC3E; //OC1, OC2 output pins enabled
9362  1d5b 3501525d      	mov	21085,#1
9363                     ; 1932 TIM1->CR1=(TIM1_CR1_CEN | TIM1_CR1_ARPE);
9365  1d5f 35815250      	mov	21072,#129
9366                     ; 1933 TIM1->BKR|= TIM1_BKR_AOE;
9368  1d63 721c526d      	bset	21101,#6
9369                     ; 1934 }
9372  1d67 81            	ret
9397                     ; 1938 void adc2_init(void)
9397                     ; 1939 {
9398                     	switch	.text
9399  1d68               _adc2_init:
9403                     ; 1940 adc_plazma[0]++;
9405  1d68 beb2          	ldw	x,_adc_plazma
9406  1d6a 1c0001        	addw	x,#1
9407  1d6d bfb2          	ldw	_adc_plazma,x
9408                     ; 1964 GPIOB->DDR&=~(1<<4);
9410  1d6f 72195007      	bres	20487,#4
9411                     ; 1965 GPIOB->CR1&=~(1<<4);
9413  1d73 72195008      	bres	20488,#4
9414                     ; 1966 GPIOB->CR2&=~(1<<4);
9416  1d77 72195009      	bres	20489,#4
9417                     ; 1968 GPIOB->DDR&=~(1<<5);
9419  1d7b 721b5007      	bres	20487,#5
9420                     ; 1969 GPIOB->CR1&=~(1<<5);
9422  1d7f 721b5008      	bres	20488,#5
9423                     ; 1970 GPIOB->CR2&=~(1<<5);
9425  1d83 721b5009      	bres	20489,#5
9426                     ; 1972 GPIOB->DDR&=~(1<<6);
9428  1d87 721d5007      	bres	20487,#6
9429                     ; 1973 GPIOB->CR1&=~(1<<6);
9431  1d8b 721d5008      	bres	20488,#6
9432                     ; 1974 GPIOB->CR2&=~(1<<6);
9434  1d8f 721d5009      	bres	20489,#6
9435                     ; 1976 GPIOB->DDR&=~(1<<7);
9437  1d93 721f5007      	bres	20487,#7
9438                     ; 1977 GPIOB->CR1&=~(1<<7);
9440  1d97 721f5008      	bres	20488,#7
9441                     ; 1978 GPIOB->CR2&=~(1<<7);
9443  1d9b 721f5009      	bres	20489,#7
9444                     ; 1988 ADC2->TDRL=0xff;
9446  1d9f 35ff5407      	mov	21511,#255
9447                     ; 1990 ADC2->CR2=0x08;
9449  1da3 35085402      	mov	21506,#8
9450                     ; 1991 ADC2->CR1=0x40;
9452  1da7 35405401      	mov	21505,#64
9453                     ; 1994 	ADC2->CSR=0x20+adc_ch+3;
9455  1dab b6bf          	ld	a,_adc_ch
9456  1dad ab23          	add	a,#35
9457  1daf c75400        	ld	21504,a
9458                     ; 1996 	ADC2->CR1|=1;
9460  1db2 72105401      	bset	21505,#0
9461                     ; 1997 	ADC2->CR1|=1;
9463  1db6 72105401      	bset	21505,#0
9464                     ; 2000 adc_plazma[1]=adc_ch;
...
9470                     ; 2001 }
9473  1dc0 81            	ret
9507                     ; 2010 @far @interrupt void TIM4_UPD_Interrupt (void) 
9507                     ; 2011 {
9509                     	switch	.text
9510  1dc1               f_TIM4_UPD_Interrupt:
9514                     ; 2012 TIM4->SR1&=~TIM4_SR1_UIF;
9516  1dc1 72115342      	bres	21314,#0
9517                     ; 2014 if(++pwm_vent_cnt>=10)pwm_vent_cnt=0;
...
9606                     ; 2054 }
9609  1e29 80            	iret
9634                     ; 2057 @far @interrupt void CAN_RX_Interrupt (void) 
9634                     ; 2058 {
9635                     	switch	.text
9636  1e2a               f_CAN_RX_Interrupt:
9640                     ; 2060 CAN->PSR= 7;									// page 7 - read messsage
9642  1e2a 35075427      	mov	21543,#7
9643                     ; 2062 memcpy(&mess[0], &CAN->Page.RxFIFO.MFMI, 14); // compare the message content
...
9902                     ; 2150 	for(i=0;i<16;i++)
9904  1f01 0f05          	clr	(OFST-4,sp)
9905  1f03               L5224:
9906                     ; 2152 		tempSS+=(signed long)adc_buff[adc_ch][i];
...
10031                     	switch	.text
10032  1f58               _main:
10036                     ; 2191 CLK->ECKR|=1;
10038  1f58 721050c1      	bset	20673,#0
10040  1f5c               L5424:
10041                     ; 2192 while((CLK->ECKR & 2) == 0);
10043  1f5c c650c1        	ld	a,20673
10044  1f5f a502          	bcp	a,#2
10045  1f61 27f9          	jreq	L5424
10046                     ; 2193 CLK->SWCR|=2;
10048  1f63 721250c5      	bset	20677,#1
10049                     ; 2194 CLK->SWR=0xB4;
10051  1f67 35b450c4      	mov	20676,#180
10052                     ; 2196 delay_ms(200);
10054  1f6b ae00c8        	ldw	x,#200
10055  1f6e cd004c        	call	_delay_ms
10057                     ; 2197 FLASH_DUKR=0xae;
10059  1f71 35ae5064      	mov	_FLASH_DUKR,#174
10060                     ; 2198 FLASH_DUKR=0x56;
10062  1f75 35565064      	mov	_FLASH_DUKR,#86
10063                     ; 2199 enableInterrupts();
10066  1f79 9a            rim
10068                     ; 2201 delay_ms(100);
10071  1f7a ae0064        	ldw	x,#100
10072  1f7d cd004c        	call	_delay_ms
10074                     ; 2202 delay_ms(100);
10076  1f80 ae0064        	ldw	x,#100
10077  1f83 cd004c        	call	_delay_ms
10079                     ; 2203 delay_ms(100);
10081  1f86 ae0064        	ldw	x,#100
10082  1f89 cd004c        	call	_delay_ms
10084                     ; 2204 delay_ms(100);
10086  1f8c ae0064        	ldw	x,#100
10087  1f8f cd004c        	call	_delay_ms
10089                     ; 2205 delay_ms(100);
10091  1f92 ae0064        	ldw	x,#100
10092  1f95 cd004c        	call	_delay_ms
10094                     ; 2207 adr_drv_v4();
10096  1f98 cd121c        	call	_adr_drv_v4
10098                     ; 2211 t4_init();
10100  1f9b cd1d1a        	call	_t4_init
10102                     ; 2213 		GPIOG->DDR|=(1<<0);
10104  1f9e 72105020      	bset	20512,#0
10105                     ; 2214 		GPIOG->CR1|=(1<<0);
10107  1fa2 72105021      	bset	20513,#0
10108                     ; 2215 		GPIOG->CR2&=~(1<<0);	
10110  1fa6 72115022      	bres	20514,#0
10111                     ; 2218 		GPIOG->DDR&=~(1<<1);
10113  1faa 72135020      	bres	20512,#1
10114                     ; 2219 		GPIOG->CR1|=(1<<1);
10116  1fae 72125021      	bset	20513,#1
10117                     ; 2220 		GPIOG->CR2&=~(1<<1);
10119  1fb2 72135022      	bres	20514,#1
10120                     ; 2222 init_CAN();
10122  1fb6 cd14d1        	call	_init_CAN
10124                     ; 2227 GPIOC->DDR|=(1<<1);
10126  1fb9 7212500c      	bset	20492,#1
10127                     ; 2228 GPIOC->CR1|=(1<<1);
10129  1fbd 7212500d      	bset	20493,#1
10130                     ; 2229 GPIOC->CR2|=(1<<1);
10132  1fc1 7212500e      	bset	20494,#1
10133                     ; 2231 GPIOC->DDR|=(1<<2);
10135  1fc5 7214500c      	bset	20492,#2
10136                     ; 2232 GPIOC->CR1|=(1<<2);
10138  1fc9 7214500d      	bset	20493,#2
10139                     ; 2233 GPIOC->CR2|=(1<<2);
10141  1fcd 7214500e      	bset	20494,#2
10142                     ; 2240 t1_init();
10144  1fd1 cd1d2b        	call	_t1_init
10146                     ; 2242 GPIOA->DDR|=(1<<5);
10148  1fd4 721a5002      	bset	20482,#5
10149                     ; 2243 GPIOA->CR1|=(1<<5);
10151  1fd8 721a5003      	bset	20483,#5
10152                     ; 2244 GPIOA->CR2&=~(1<<5);
10154  1fdc 721b5004      	bres	20484,#5
10155                     ; 2250 GPIOB->DDR|=(1<<3);
10157  1fe0 72165007      	bset	20487,#3
10158                     ; 2251 GPIOB->CR1|=(1<<3);
10160  1fe4 72165008      	bset	20488,#3
10161                     ; 2252 GPIOB->CR2|=(1<<3);
10163  1fe8 72165009      	bset	20489,#3
10164                     ; 2254 GPIOC->DDR|=(1<<3);
10166  1fec 7216500c      	bset	20492,#3
10167                     ; 2255 GPIOC->CR1|=(1<<3);
10169  1ff0 7216500d      	bset	20493,#3
10170                     ; 2256 GPIOC->CR2|=(1<<3);
10172  1ff4 7216500e      	bset	20494,#3
10173                     ; 2259 if(bps_class==bpsIPS) 
10175  1ff8 b601          	ld	a,_bps_class
10176  1ffa a101          	cp	a,#1
10177  1ffc 260a          	jrne	L3524
10178                     ; 2261 	pwm_u=ee_U_AVT;
10180  1ffe ce000a        	ldw	x,_ee_U_AVT
10181  2001 bf0b          	ldw	_pwm_u,x
10182                     ; 2262 	volum_u_main_=ee_U_AVT;
10184  2003 ce000a        	ldw	x,_ee_U_AVT
10185  2006 bf1c          	ldw	_volum_u_main_,x
10186  2008               L3524:
10187                     ; 2269 	if(bCAN_RX)
10189  2008 3d09          	tnz	_bCAN_RX
10190  200a 2705          	jreq	L7524
10191                     ; 2271 		bCAN_RX=0;
10193  200c 3f09          	clr	_bCAN_RX
10194                     ; 2272 		can_in_an();	
10196  200e cd16dc        	call	_can_in_an
10198  2011               L7524:
10199                     ; 2274 	if(b100Hz)
10201                     	btst	_b100Hz
10202  2016 240a          	jruge	L1624
10203                     ; 2276 		b100Hz=0;
10205  2018 72110008      	bres	_b100Hz
10206                     ; 2285 		adc2_init();
10208  201c cd1d68        	call	_adc2_init
10210                     ; 2286 		can_tx_hndl();
10212  201f cd15c4        	call	_can_tx_hndl
10214  2022               L1624:
10215                     ; 2289 	if(b10Hz)
10217                     	btst	_b10Hz
10218  2027 2419          	jruge	L3624
10219                     ; 2291 		b10Hz=0;
10221  2029 72110007      	bres	_b10Hz
10222                     ; 2293           matemat();
10224  202d cd0bca        	call	_matemat
10226                     ; 2294 	    	led_drv(); 
10228  2030 cd0711        	call	_led_drv
10230                     ; 2295 	     link_drv();
10232  2033 cd07ff        	call	_link_drv
10234                     ; 2296 	     pwr_hndl();		//вычисление воздействий на силу
10236  2036 cd0aae        	call	_pwr_hndl
10238                     ; 2297 	     JP_drv();
10240  2039 cd0774        	call	_JP_drv
10242                     ; 2298 	     flags_drv();
10244  203c cd0fc8        	call	_flags_drv
10246                     ; 2299 		net_drv();
10248  203f cd162e        	call	_net_drv
10250  2042               L3624:
10251                     ; 2302 	if(b5Hz)
10253                     	btst	_b5Hz
10254  2047 240d          	jruge	L5624
10255                     ; 2304 		b5Hz=0;
10257  2049 72110006      	bres	_b5Hz
10258                     ; 2306 		pwr_drv();		//воздействие на силу
10260  204d cd09aa        	call	_pwr_drv
10262                     ; 2307 		led_hndl();
10264  2050 cd008e        	call	_led_hndl
10266                     ; 2309 		vent_drv();
10268  2053 cd084e        	call	_vent_drv
10270  2056               L5624:
10271                     ; 2312 	if(b2Hz)
10273                     	btst	_b2Hz
10274  205b 2404          	jruge	L7624
10275                     ; 2314 		b2Hz=0;
10277  205d 72110005      	bres	_b2Hz
10278  2061               L7624:
10279                     ; 2323 	if(b1Hz)
10281                     	btst	_b1Hz
10282  2066 24a0          	jruge	L3524
10283                     ; 2325 		b1Hz=0;
10285  2068 72110004      	bres	_b1Hz
10286                     ; 2327 		temper_drv();			//вычисление аварий температуры
10288  206c cd0cf8        	call	_temper_drv
10290                     ; 2328 		u_drv();
10292  206f cd0dcf        	call	_u_drv
10294                     ; 2329           x_drv();
10296  2072 cd0eaf        	call	_x_drv
10298                     ; 2330           if(main_cnt<1000)main_cnt++;
10300  2075 9c            	rvf
10301  2076 be4e          	ldw	x,_main_cnt
10302  2078 a303e8        	cpw	x,#1000
10303  207b 2e07          	jrsge	L3724
10306  207d be4e          	ldw	x,_main_cnt
10307  207f 1c0001        	addw	x,#1
10308  2082 bf4e          	ldw	_main_cnt,x
10309  2084               L3724:
10310                     ; 2331   		if((link==OFF)||(jp_mode==jp3))apv_hndl();
10312  2084 b65f          	ld	a,_link
10313  2086 a1aa          	cp	a,#170
10314  2088 2706          	jreq	L7724
10316  208a b647          	ld	a,_jp_mode
10317  208c a103          	cp	a,#3
10318  208e 2603          	jrne	L5724
10319  2090               L7724:
10322  2090 cd0f29        	call	_apv_hndl
10324  2093               L5724:
10325                     ; 2334   		can_error_cnt++;
10327  2093 3c6d          	inc	_can_error_cnt
10328                     ; 2335   		if(can_error_cnt>=10)
10330  2095 b66d          	ld	a,_can_error_cnt
10331  2097 a10a          	cp	a,#10
10332  2099 2505          	jrult	L1034
10333                     ; 2337   			can_error_cnt=0;
10335  209b 3f6d          	clr	_can_error_cnt
10336                     ; 2338 			init_CAN();
10338  209d cd14d1        	call	_init_CAN
10340  20a0               L1034:
10341                     ; 2342 		volum_u_main_drv();
10343  20a0 cd137e        	call	_volum_u_main_drv
10345                     ; 2344 		pwm_stat++;
10347  20a3 3c04          	inc	_pwm_stat
10348                     ; 2345 		if(pwm_stat>=10)pwm_stat=0;
10350  20a5 b604          	ld	a,_pwm_stat
10351  20a7 a10a          	cp	a,#10
10352  20a9 2502          	jrult	L3034
10355  20ab 3f04          	clr	_pwm_stat
10356  20ad               L3034:
10357                     ; 2346 adc_plazma_short++;
10359  20ad bebc          	ldw	x,_adc_plazma_short
10360  20af 1c0001        	addw	x,#1
10361  20b2 bfbc          	ldw	_adc_plazma_short,x
10362  20b4 ac082008      	jpf	L3524
11376                     	xdef	_main
11377                     	xdef	f_ADC2_EOC_Interrupt
11378                     	xdef	f_CAN_TX_Interrupt
11379                     	xdef	f_CAN_RX_Interrupt
11380                     	xdef	f_TIM4_UPD_Interrupt
11381                     	xdef	_adc2_init
11382                     	xdef	_t1_init
11383                     	xdef	_t4_init
11384                     	xdef	_can_in_an
11385                     	xdef	_net_drv
11386                     	xdef	_can_tx_hndl
11387                     	xdef	_can_transmit
11388                     	xdef	_init_CAN
11389                     	xdef	_volum_u_main_drv
11390                     	xdef	_adr_drv_v4
11391                     	xdef	_adr_drv_v3
11392                     	xdef	_adr_gran
11393                     	xdef	_flags_drv
11394                     	xdef	_apv_hndl
11395                     	xdef	_apv_stop
11396                     	xdef	_apv_start
11397                     	xdef	_x_drv
11398                     	xdef	_u_drv
11399                     	xdef	_temper_drv
11400                     	xdef	_matemat
11401                     	xdef	_pwr_hndl
11402                     	xdef	_pwr_drv
11403                     	xdef	_vent_drv
11404                     	xdef	_link_drv
11405                     	xdef	_JP_drv
11406                     	xdef	_led_drv
11407                     	xdef	_led_hndl
11408                     	xdef	_delay_ms
11409                     	xdef	_granee
11410                     	xdef	_gran
11411                     .eeprom:	section	.data
11412  0000               _ee_IMAXVENT:
11413  0000 0000          	ds.b	2
11414                     	xdef	_ee_IMAXVENT
11415                     	switch	.ubsct
11416  0001               _bps_class:
11417  0001 00            	ds.b	1
11418                     	xdef	_bps_class
11419  0002               _vent_pwm:
11420  0002 0000          	ds.b	2
11421                     	xdef	_vent_pwm
11422  0004               _pwm_stat:
11423  0004 00            	ds.b	1
11424                     	xdef	_pwm_stat
11425  0005               _pwm_vent_cnt:
11426  0005 00            	ds.b	1
11427                     	xdef	_pwm_vent_cnt
11428                     	switch	.eeprom
11429  0002               _ee_DEVICE:
11430  0002 0000          	ds.b	2
11431                     	xdef	_ee_DEVICE
11432  0004               _ee_AVT_MODE:
11433  0004 0000          	ds.b	2
11434                     	xdef	_ee_AVT_MODE
11435                     	switch	.ubsct
11436  0006               _i_main_bps_cnt:
11437  0006 000000000000  	ds.b	6
11438                     	xdef	_i_main_bps_cnt
11439  000c               _i_main_sigma:
11440  000c 0000          	ds.b	2
11441                     	xdef	_i_main_sigma
11442  000e               _i_main_num_of_bps:
11443  000e 00            	ds.b	1
11444                     	xdef	_i_main_num_of_bps
11445  000f               _i_main_avg:
11446  000f 0000          	ds.b	2
11447                     	xdef	_i_main_avg
11448  0011               _i_main_flag:
11449  0011 000000000000  	ds.b	6
11450                     	xdef	_i_main_flag
11451  0017               _i_main:
11452  0017 000000000000  	ds.b	12
11453                     	xdef	_i_main
11454  0023               _x:
11455  0023 000000000000  	ds.b	12
11456                     	xdef	_x
11457                     	xdef	_volum_u_main_
11458                     	switch	.eeprom
11459  0006               _UU_AVT:
11460  0006 0000          	ds.b	2
11461                     	xdef	_UU_AVT
11462                     	switch	.ubsct
11463  002f               _cnt_net_drv:
11464  002f 00            	ds.b	1
11465                     	xdef	_cnt_net_drv
11466                     	switch	.bit
11467  0001               _bMAIN:
11468  0001 00            	ds.b	1
11469                     	xdef	_bMAIN
11470                     	switch	.ubsct
11471  0030               _plazma_int:
11472  0030 000000000000  	ds.b	6
11473                     	xdef	_plazma_int
11474                     	xdef	_rotor_int
11475  0036               _led_green_buff:
11476  0036 00000000      	ds.b	4
11477                     	xdef	_led_green_buff
11478  003a               _led_red_buff:
11479  003a 00000000      	ds.b	4
11480                     	xdef	_led_red_buff
11481                     	xdef	_led_drv_cnt
11482                     	xdef	_led_green
11483                     	xdef	_led_red
11484  003e               _res_fl_cnt:
11485  003e 00            	ds.b	1
11486                     	xdef	_res_fl_cnt
11487                     	xdef	_bRES_
11488                     	xdef	_bRES
11489                     	switch	.eeprom
11490  0008               _res_fl_:
11491  0008 00            	ds.b	1
11492                     	xdef	_res_fl_
11493  0009               _res_fl:
11494  0009 00            	ds.b	1
11495                     	xdef	_res_fl
11496                     	switch	.ubsct
11497  003f               _cnt_apv_off:
11498  003f 00            	ds.b	1
11499                     	xdef	_cnt_apv_off
11500                     	switch	.bit
11501  0002               _bAPV:
11502  0002 00            	ds.b	1
11503                     	xdef	_bAPV
11504                     	switch	.ubsct
11505  0040               _apv_cnt_:
11506  0040 0000          	ds.b	2
11507                     	xdef	_apv_cnt_
11508  0042               _apv_cnt:
11509  0042 000000        	ds.b	3
11510                     	xdef	_apv_cnt
11511                     	xdef	_bBL_IPS
11512                     	switch	.bit
11513  0003               _bBL:
11514  0003 00            	ds.b	1
11515                     	xdef	_bBL
11516                     	switch	.ubsct
11517  0045               _cnt_JP1:
11518  0045 00            	ds.b	1
11519                     	xdef	_cnt_JP1
11520  0046               _cnt_JP0:
11521  0046 00            	ds.b	1
11522                     	xdef	_cnt_JP0
11523  0047               _jp_mode:
11524  0047 00            	ds.b	1
11525                     	xdef	_jp_mode
11526                     	xdef	_pwm_i
11527                     	xdef	_pwm_u
11528  0048               _tmax_cnt:
11529  0048 0000          	ds.b	2
11530                     	xdef	_tmax_cnt
11531  004a               _tsign_cnt:
11532  004a 0000          	ds.b	2
11533                     	xdef	_tsign_cnt
11534                     	switch	.eeprom
11535  000a               _ee_U_AVT:
11536  000a 0000          	ds.b	2
11537                     	xdef	_ee_U_AVT
11538  000c               _ee_tsign:
11539  000c 0000          	ds.b	2
11540                     	xdef	_ee_tsign
11541  000e               _ee_tmax:
11542  000e 0000          	ds.b	2
11543                     	xdef	_ee_tmax
11544  0010               _ee_dU:
11545  0010 0000          	ds.b	2
11546                     	xdef	_ee_dU
11547  0012               _ee_Umax:
11548  0012 0000          	ds.b	2
11549                     	xdef	_ee_Umax
11550  0014               _ee_TZAS:
11551  0014 0000          	ds.b	2
11552                     	xdef	_ee_TZAS
11553                     	switch	.ubsct
11554  004c               _main_cnt1:
11555  004c 0000          	ds.b	2
11556                     	xdef	_main_cnt1
11557  004e               _main_cnt:
11558  004e 0000          	ds.b	2
11559                     	xdef	_main_cnt
11560  0050               _off_bp_cnt:
11561  0050 00            	ds.b	1
11562                     	xdef	_off_bp_cnt
11563  0051               _flags_tu_cnt_off:
11564  0051 00            	ds.b	1
11565                     	xdef	_flags_tu_cnt_off
11566  0052               _flags_tu_cnt_on:
11567  0052 00            	ds.b	1
11568                     	xdef	_flags_tu_cnt_on
11569  0053               _vol_i_temp:
11570  0053 0000          	ds.b	2
11571                     	xdef	_vol_i_temp
11572  0055               _vol_u_temp:
11573  0055 0000          	ds.b	2
11574                     	xdef	_vol_u_temp
11575                     	switch	.eeprom
11576  0016               __x_ee_:
11577  0016 0000          	ds.b	2
11578                     	xdef	__x_ee_
11579                     	switch	.ubsct
11580  0057               __x_cnt:
11581  0057 0000          	ds.b	2
11582                     	xdef	__x_cnt
11583  0059               __x__:
11584  0059 0000          	ds.b	2
11585                     	xdef	__x__
11586  005b               __x_:
11587  005b 0000          	ds.b	2
11588                     	xdef	__x_
11589  005d               _flags_tu:
11590  005d 00            	ds.b	1
11591                     	xdef	_flags_tu
11592                     	xdef	_flags
11593  005e               _link_cnt:
11594  005e 00            	ds.b	1
11595                     	xdef	_link_cnt
11596  005f               _link:
11597  005f 00            	ds.b	1
11598                     	xdef	_link
11599  0060               _umin_cnt:
11600  0060 0000          	ds.b	2
11601                     	xdef	_umin_cnt
11602  0062               _umax_cnt:
11603  0062 0000          	ds.b	2
11604                     	xdef	_umax_cnt
11605                     	switch	.eeprom
11606  0018               _ee_K:
11607  0018 000000000000  	ds.b	16
11608                     	xdef	_ee_K
11609                     	switch	.ubsct
11610  0064               _T:
11611  0064 00            	ds.b	1
11612                     	xdef	_T
11613  0065               _Udb:
11614  0065 0000          	ds.b	2
11615                     	xdef	_Udb
11616  0067               _Ui:
11617  0067 0000          	ds.b	2
11618                     	xdef	_Ui
11619  0069               _Un:
11620  0069 0000          	ds.b	2
11621                     	xdef	_Un
11622  006b               _I:
11623  006b 0000          	ds.b	2
11624                     	xdef	_I
11625  006d               _can_error_cnt:
11626  006d 00            	ds.b	1
11627                     	xdef	_can_error_cnt
11628                     	xdef	_bCAN_RX
11629  006e               _tx_busy_cnt:
11630  006e 00            	ds.b	1
11631                     	xdef	_tx_busy_cnt
11632                     	xdef	_bTX_FREE
11633  006f               _can_buff_rd_ptr:
11634  006f 00            	ds.b	1
11635                     	xdef	_can_buff_rd_ptr
11636  0070               _can_buff_wr_ptr:
11637  0070 00            	ds.b	1
11638                     	xdef	_can_buff_wr_ptr
11639  0071               _can_out_buff:
11640  0071 000000000000  	ds.b	64
11641                     	xdef	_can_out_buff
11642                     	switch	.bss
11643  0000               _adress_error:
11644  0000 00            	ds.b	1
11645                     	xdef	_adress_error
11646  0001               _adress:
11647  0001 00            	ds.b	1
11648                     	xdef	_adress
11649  0002               _adr:
11650  0002 000000        	ds.b	3
11651                     	xdef	_adr
11652                     	xdef	_adr_drv_stat
11653                     	xdef	_led_ind
11654                     	switch	.ubsct
11655  00b1               _led_ind_cnt:
11656  00b1 00            	ds.b	1
11657                     	xdef	_led_ind_cnt
11658  00b2               _adc_plazma:
11659  00b2 000000000000  	ds.b	10
11660                     	xdef	_adc_plazma
11661  00bc               _adc_plazma_short:
11662  00bc 0000          	ds.b	2
11663                     	xdef	_adc_plazma_short
11664  00be               _adc_cnt:
11665  00be 00            	ds.b	1
11666                     	xdef	_adc_cnt
11667  00bf               _adc_ch:
11668  00bf 00            	ds.b	1
11669                     	xdef	_adc_ch
11670                     	switch	.bss
11671  0005               _adc_buff_:
11672  0005 000000000000  	ds.b	20
11673                     	xdef	_adc_buff_
11674  0019               _adc_buff:
11675  0019 000000000000  	ds.b	320
11676                     	xdef	_adc_buff
11677                     	switch	.ubsct
11678  00c0               _mess:
11679  00c0 000000000000  	ds.b	14
11680                     	xdef	_mess
11681                     	switch	.bit
11682  0004               _b1Hz:
11683  0004 00            	ds.b	1
11684                     	xdef	_b1Hz
11685  0005               _b2Hz:
11686  0005 00            	ds.b	1
11687                     	xdef	_b2Hz
11688  0006               _b5Hz:
11689  0006 00            	ds.b	1
11690                     	xdef	_b5Hz
11691  0007               _b10Hz:
11692  0007 00            	ds.b	1
11693                     	xdef	_b10Hz
11694  0008               _b100Hz:
11695  0008 00            	ds.b	1
11696                     	xdef	_b100Hz
11697                     	xdef	_t0_cnt4
11698                     	xdef	_t0_cnt3
11699                     	xdef	_t0_cnt2
