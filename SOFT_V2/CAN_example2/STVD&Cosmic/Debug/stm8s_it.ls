  ...
  48                     ; 37 @far @interrupt void NonHandledInterrupt (void)
  48                     ; 38 {
  49                     	switch	.text
 ...
 151  0059 00            	dc.b	page(f_UARTTxInterrupt)
 152  005a 0000          	dc.w	f_UARTTxInterrupt
 153  005c 82            	dc.b	130
 155  005d 00            	dc.b	page(f_UARTRxInterrupt)
 156  005e 0000          	dc.w	f_UARTRxInterrupt
 ...
 239                     	xdef	__vectab
 240                     	xref	f_UARTRxInterrupt
 241                     	xref	f_UARTTxInterrupt
 242                     	xref	__stext
