...
if((RXBUFF1[0]==adr)&&(RXBUFF1[1]==adr)&&((RXBUFF1[2]==GETTM) || (RXBUFF1[2]==GETTM1) || (RXBUFF1[2]==GETTM2)))	
	...
	can_transmit1(adr,PUTTM2,(char)T,0,flags,_x_,*((char*)&plazma_int[2]/*rotor_int*/),*(((char*)&plazma_int[2]/*rotor_int*/)+1));
	if(RXBUFF1[2]==GETTM)	can_transmit1(adr,PUTTM3,/**(((char*)&debug_info_to_uku[0])+1)*/0,/**((char*)&debug_info_to_uku[0])*/0,/**(((char*)&debug_info_to_uku[1])+1)*/0,/**((char*)&	debug_info_to_uku[1])*/0,/**(((char*)&debug_info_to_uku[2])+1)*/0,/**((char*)&debug_info_to_uku[2])*/0);
	if(RXBUFF1[2]==GETTM1)	can_transmit1(adr,PUTTM31,*(((char*)&HARDVARE_VERSION)+1),*((char*)&HARDVARE_VERSION),*(((char*)&SOFT_VERSION)+1),*((char*)&SOFT_VERSION),*(((char*)&BUILD)+1),*((char*)&BUILD));
	if(RXBUFF1[2]==GETTM2)	can_transmit1(adr,PUTTM32,*(((char*)&BUILD_YEAR)+1),*((char*)&BUILD_YEAR),*(((char*)&BUILD_MONTH)+1),*((char*)&BUILD_MONTH),*(((char*)&BUILD_DAY)+1),*((char*)&BUILD_DAY));
...
/*if(bMAIN)
    ...
    if(cnt_net_drv<=5) 
        ...
        {
        plazma_int[2]=pwm_u;
        can_transmit1(adr,PUTTM1,*(((char*)&I)+1),*((char*)&I),*(((char*)&Un)+1),*((char*)&Un),*(((char*)&Ui)+1),*((char*)&Ui));
        can_transmit1(adr,PUTTM2,T,vent_resurs_buff[vent_resurs_tx_cnt],flags,_x_,*(((char*)&plazma_int[2])+1),*((char*)&plazma_int[2]));
        }
    } */
}   
