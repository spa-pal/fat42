...
if((adc_buff_[0]>=(ADR_CONST_0-40))&&(adc_buff_[0]<=(ADR_CONST_0+40))) adr[0]=0;
else if((adc_buff_[0]>=(ADR_CONST_1-40))&&(adc_buff_[0]<=(ADR_CONST_1+40))) adr[0]=1;
else if((adc_buff_[0]>=(ADR_CONST_2-40))&&(adc_buff_[0]<=(ADR_CONST_2+40))) adr[0]=2;
else if((adc_buff_[0]>=(ADR_CONST_3-40))&&(adc_buff_[0]<=(ADR_CONST_3+40))) adr[0]=3;
else adr[0]=5;

if((adc_buff_[1]>=(ADR_CONST_0-40))&&(adc_buff_[1]<=(ADR_CONST_0+40))) adr[1]=0;
else if((adc_buff_[1]>=(ADR_CONST_1-40))&&(adc_buff_[1]<=(ADR_CONST_1+40))) adr[1]=1;
else if((adc_buff_[1]>=(ADR_CONST_2-40))&&(adc_buff_[1]<=(ADR_CONST_2+40))) adr[1]=2;
else if((adc_buff_[1]>=(ADR_CONST_3-40))&&(adc_buff_[1]<=(ADR_CONST_3+40))) adr[1]=3;
else adr[1]=5;

if((adc_buff_[9]>=(ADR_CONST_0-40))&&(adc_buff_[9]<=(ADR_CONST_0+40))) adr[2]=0;
else if((adc_buff_[9]>=(ADR_CONST_1-40))&&(adc_buff_[9]<=(ADR_CONST_1+40))) adr[2]=1;
else if((adc_buff_[9]>=(ADR_CONST_2-40))&&(adc_buff_[9]<=(ADR_CONST_2+40))) adr[2]=2;
else if((adc_buff_[9]>=(ADR_CONST_3-40))&&(adc_buff_[9]<=(ADR_CONST_3+40))) adr[2]=3;
else adr[2]=5;
