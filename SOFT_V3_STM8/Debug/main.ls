...
4648  0a8b               _pwr_drv:
4652                     ; 711 BLOCK_INIT
4654  0a8b 721a500c      	bset	20492,#5
4657  0a8f 721a500d      	bset	20493,#5
4660  0a93 721b500e      	bres	20494,#5
...
4681                     ; 724 		BLOCK_ON
4683  0ab2 721a500a      	bset	20490,#5
...
4695  0ac8               L26:
4696                     ; 728 		BLOCK_OFF
4698  0ac8 721b500a      	bres	20490,#5
...
4717                     ; 733 	BLOCK_ON
4719  0ae7 721a500a      	bset	20490,#5
...
4735                     ; 741 			 BLOCK_ON
4737  0b00 721a500a      	bset	20490,#5
...
4748                     ; 746 			  BLOCK_OFF
4750  0b12 721b500a      	bres	20490,#5
...
4779                     ; 754 		  BLOCK_OFF
4781  0b41 721b500a      	bres	20490,#5
...
4830                     ; 773 	BLOCK_ON
4832  0b79 721a500a      	bset	20490,#5
...
4843                     ; 778 	BLOCK_OFF
4845  0b8a 721b500a      	bres	20490,#5
...
5445                     ; 979 temp_SL=adc_buff_[7];
5447  0e02 ce0017        	ldw	x,_adc_buff_+14
...
5501                     ; 989 temp_SL=(signed long)adc_buff_[4];
5503  0e50 ce0011        	ldw	x,_adc_buff_+8
...
5548                     ; 1001 temp_SL=adc_buff_[6];
5550  0e91 ce0015        	ldw	x,_adc_buff_+12
...
5595                     ; 1009 temp_SL=adc_buff_[5];
5597  0ed2 ce0013        	ldw	x,_adc_buff_+10
...
6023  109c c6500a        	ld	a,20490
6024  109f a520          	bcp	a,#32
...
6111  1107 c6500a        	ld	a,20490
6112  110a a520          	bcp	a,#32
...
6539  1231 c6500a        	ld	a,20490
6540  1234 a520          	bcp	a,#32
...
8461                     ; 1733 			ee_K[0][0]=adc_buff_[7];
8463  193e ce0017        	ldw	x,_adc_buff_+14
...
9610                     ; 1997 GPIOB->DDR&=~(1<<2);
9612  1ea6 72155007      	bres	20487,#2
9613                     ; 1998 GPIOB->CR1&=~(1<<2);
9615  1eaa 72155008      	bres	20488,#2
9616                     ; 1999 GPIOB->CR2&=~(1<<2);
9618  1eae 72155009      	bres	20489,#2
9619                     ; 2001 GPIOB->DDR&=~(1<<3);
9621  1eb2 72175007      	bres	20487,#3
9622                     ; 2002 GPIOB->CR1&=~(1<<3);
9624  1eb6 72175008      	bres	20488,#3
9625                     ; 2003 GPIOB->CR2&=~(1<<3);
9627  1eba 72175009      	bres	20489,#3
9628                     ; 2005 GPIOB->DDR&=~(1<<4);
9630  1ebe 72195007      	bres	20487,#4
9631                     ; 2006 GPIOB->CR1&=~(1<<4);
9633  1ec2 72195008      	bres	20488,#4
9634                     ; 2007 GPIOB->CR2&=~(1<<4);
9636  1ec6 72195009      	bres	20489,#4
9637                     ; 2009 GPIOB->DDR&=~(1<<5);
9639  1eca 721b5007      	bres	20487,#5
9640                     ; 2010 GPIOB->CR1&=~(1<<5);
9642  1ece 721b5008      	bres	20488,#5
9643                     ; 2011 GPIOB->CR2&=~(1<<5);
9645  1ed2 721b5009      	bres	20489,#5
9646                     ; 2013 GPIOB->DDR&=~(1<<6);
9648  1ed6 721d5007      	bres	20487,#6
9649                     ; 2014 GPIOB->CR1&=~(1<<6);
9651  1eda 721d5008      	bres	20488,#6
9652                     ; 2015 GPIOB->CR2&=~(1<<6);
9654  1ede 721d5009      	bres	20489,#6
9655                     ; 2017 GPIOB->DDR&=~(1<<7);
9657  1ee2 721f5007      	bres	20487,#7
9658                     ; 2018 GPIOB->CR1&=~(1<<7);
9660  1ee6 721f5008      	bres	20488,#7
9661                     ; 2019 GPIOB->CR2&=~(1<<7);
9663  1eea 721f5009      	bres	20489,#7
9664                     ; 2029 ADC2->TDRL=0xff;
9666  1eee 35ff5407      	mov	21511,#255
9667                     ; 2031 ADC2->CR2=0x08;
9669  1ef2 35085402      	mov	21506,#8
9670                     ; 2032 ADC2->CR1=0x40;
9672  1ef6 35405401      	mov	21505,#64
9673                     ; 2035 	ADC2->CSR=0x20+adc_ch;
9675  1efa b6c3          	ld	a,_adc_ch
9676  1efc ab20          	add	a,#32
9677  1efe c75400        	ld	21504,a
9678                     ; 2037 	ADC2->CR1|=1;
9680  1f01 72105401      	bset	21505,#0
9681                     ; 2038 	ADC2->CR1|=1;
9683  1f05 72105401      	bset	21505,#0
9684                     ; 2041 adc_plazma[1]=adc_ch;
9686  1f09 b6c3          	ld	a,_adc_ch
9687  1f0b 5f            	clrw	x
9688  1f0c 97            	ld	xl,a
9689  1f0d bfb8          	ldw	_adc_plazma+2,x
9690                     ; 2042 }
9693  1f0f 81            	ret
9727                     ; 2051 @far @interrupt void TIM4_UPD_Interrupt (void) 
9727                     ; 2052 {
9729                     	switch	.text
9730  1f10               f_TIM4_UPD_Interrupt:
9734                     ; 2053 TIM4->SR1&=~TIM4_SR1_UIF;
9736  1f10 72115342      	bres	21314,#0
9737                     ; 2055 if(++pwm_vent_cnt>=10)pwm_vent_cnt=0;
9739  1f14 3c08          	inc	_pwm_vent_cnt
9740  1f16 b608          	ld	a,_pwm_vent_cnt
9741  1f18 a10a          	cp	a,#10
9742  1f1a 2502          	jrult	L1314
9745  1f1c 3f08          	clr	_pwm_vent_cnt
9746  1f1e               L1314:
9747                     ; 2056 GPIOB->ODR|=(1<<3);
9749  1f1e 72165005      	bset	20485,#3
9750                     ; 2057 if(pwm_vent_cnt>=5)GPIOB->ODR&=~(1<<3);
9752  1f22 b608          	ld	a,_pwm_vent_cnt
9753  1f24 a105          	cp	a,#5
9754  1f26 2504          	jrult	L3314
9757  1f28 72175005      	bres	20485,#3
9758  1f2c               L3314:
9759                     ; 2062 if(++t0_cnt0>=100)
9761  1f2c 9c            	rvf
9762  1f2d be01          	ldw	x,_t0_cnt0
9763  1f2f 1c0001        	addw	x,#1
9764  1f32 bf01          	ldw	_t0_cnt0,x
9765  1f34 a30064        	cpw	x,#100
9766  1f37 2f3f          	jrslt	L5314
9767                     ; 2064 	t0_cnt0=0;
9769  1f39 5f            	clrw	x
9770  1f3a bf01          	ldw	_t0_cnt0,x
9771                     ; 2065 	b100Hz=1;
9773  1f3c 72100008      	bset	_b100Hz
9774                     ; 2067 	if(++t0_cnt1>=10)
9776  1f40 3c03          	inc	_t0_cnt1
9777  1f42 b603          	ld	a,_t0_cnt1
9778  1f44 a10a          	cp	a,#10
9779  1f46 2506          	jrult	L7314
9780                     ; 2069 		t0_cnt1=0;
9782  1f48 3f03          	clr	_t0_cnt1
9783                     ; 2070 		b10Hz=1;
9785  1f4a 72100007      	bset	_b10Hz
9786  1f4e               L7314:
9787                     ; 2073 	if(++t0_cnt2>=20)
9789  1f4e 3c04          	inc	_t0_cnt2
9790  1f50 b604          	ld	a,_t0_cnt2
9791  1f52 a114          	cp	a,#20
9792  1f54 2506          	jrult	L1414
9793                     ; 2075 		t0_cnt2=0;
9795  1f56 3f04          	clr	_t0_cnt2
9796                     ; 2076 		b5Hz=1;
9798  1f58 72100006      	bset	_b5Hz
9799  1f5c               L1414:
9800                     ; 2080 	if(++t0_cnt4>=50)
9802  1f5c 3c06          	inc	_t0_cnt4
9803  1f5e b606          	ld	a,_t0_cnt4
9804  1f60 a132          	cp	a,#50
9805  1f62 2506          	jrult	L3414
9806                     ; 2082 		t0_cnt4=0;
9808  1f64 3f06          	clr	_t0_cnt4
9809                     ; 2083 		b2Hz=1;
9811  1f66 72100005      	bset	_b2Hz
9812  1f6a               L3414:
9813                     ; 2086 	if(++t0_cnt3>=100)
9815  1f6a 3c05          	inc	_t0_cnt3
9816  1f6c b605          	ld	a,_t0_cnt3
9817  1f6e a164          	cp	a,#100
9818  1f70 2506          	jrult	L5314
9819                     ; 2088 		t0_cnt3=0;
9821  1f72 3f05          	clr	_t0_cnt3
9822                     ; 2089 		b1Hz=1;
9824  1f74 72100004      	bset	_b1Hz
9825  1f78               L5314:
9826                     ; 2095 }
9829  1f78 80            	iret
9854                     ; 2098 @far @interrupt void CAN_RX_Interrupt (void) 
9854                     ; 2099 {
9855                     	switch	.text
9856  1f79               f_CAN_RX_Interrupt:
9860                     ; 2101 CAN->PSR= 7;									// page 7 - read messsage
9862  1f79 35075427      	mov	21543,#7
9863                     ; 2103 memcpy(&mess[0], &CAN->Page.RxFIFO.MFMI, 14); // compare the message content
9865  1f7d ae000e        	ldw	x,#14
9866  1f80               L462:
9867  1f80 d65427        	ld	a,(21543,x)
9868  1f83 e7c3          	ld	(_mess-1,x),a
9869  1f85 5a            	decw	x
9870  1f86 26f8          	jrne	L462
9871                     ; 2114 bCAN_RX=1;
9873  1f88 3501000a      	mov	_bCAN_RX,#1
9874                     ; 2115 CAN->RFR|=(1<<5);
9876  1f8c 721a5424      	bset	21540,#5
9877                     ; 2117 }
9880  1f90 80            	iret
9903                     ; 2120 @far @interrupt void CAN_TX_Interrupt (void) 
9903                     ; 2121 {
9904                     	switch	.text
9905  1f91               f_CAN_TX_Interrupt:
9909                     ; 2122 if((CAN->TSR)&(1<<0))
9911  1f91 c65422        	ld	a,21538
9912  1f94 a501          	bcp	a,#1
9913  1f96 2708          	jreq	L7614
9914                     ; 2124 	bTX_FREE=1;	
9916  1f98 35010009      	mov	_bTX_FREE,#1
9917                     ; 2126 	CAN->TSR|=(1<<0);
9919  1f9c 72105422      	bset	21538,#0
9920  1fa0               L7614:
9921                     ; 2128 }
9924  1fa0 80            	iret
9982                     ; 2131 @far @interrupt void ADC2_EOC_Interrupt (void) {
9983                     	switch	.text
9984  1fa1               f_ADC2_EOC_Interrupt:
9986       00000009      OFST:	set	9
9987  1fa1 be00          	ldw	x,c_x
9988  1fa3 89            	pushw	x
9989  1fa4 be00          	ldw	x,c_y
9990  1fa6 89            	pushw	x
9991  1fa7 be02          	ldw	x,c_lreg+2
9992  1fa9 89            	pushw	x
9993  1faa be00          	ldw	x,c_lreg
9994  1fac 89            	pushw	x
9995  1fad 5209          	subw	sp,#9
9998                     ; 2136 adc_plazma[2]++;
10000  1faf beba          	ldw	x,_adc_plazma+4
10001  1fb1 1c0001        	addw	x,#1
10002  1fb4 bfba          	ldw	_adc_plazma+4,x
10003                     ; 2143 ADC2->CSR&=~(1<<7);
10005  1fb6 721f5400      	bres	21504,#7
10006                     ; 2145 temp_adc=(((signed long)(ADC2->DRH))*256)+((signed long)(ADC2->DRL));
10008  1fba c65405        	ld	a,21509
10009  1fbd b703          	ld	c_lreg+3,a
10010  1fbf 3f02          	clr	c_lreg+2
10011  1fc1 3f01          	clr	c_lreg+1
10012  1fc3 3f00          	clr	c_lreg
10013  1fc5 96            	ldw	x,sp
10014  1fc6 1c0001        	addw	x,#OFST-8
10015  1fc9 cd0000        	call	c_rtol
10017  1fcc c65404        	ld	a,21508
10018  1fcf 5f            	clrw	x
10019  1fd0 97            	ld	xl,a
10020  1fd1 90ae0100      	ldw	y,#256
10021  1fd5 cd0000        	call	c_umul
10023  1fd8 96            	ldw	x,sp
10024  1fd9 1c0001        	addw	x,#OFST-8
10025  1fdc cd0000        	call	c_ladd
10027  1fdf 96            	ldw	x,sp
10028  1fe0 1c0006        	addw	x,#OFST-3
10029  1fe3 cd0000        	call	c_rtol
10031                     ; 2150 if(adr_drv_stat==1)
10033  1fe6 b608          	ld	a,_adr_drv_stat
10034  1fe8 a101          	cp	a,#1
10035  1fea 260b          	jrne	L7124
10036                     ; 2152 	adr_drv_stat=2;
10038  1fec 35020008      	mov	_adr_drv_stat,#2
10039                     ; 2153 	adc_buff_[0]=temp_adc;
10041  1ff0 1e08          	ldw	x,(OFST-1,sp)
10042  1ff2 cf0009        	ldw	_adc_buff_,x
10044  1ff5 2020          	jra	L1224
10045  1ff7               L7124:
10046                     ; 2156 else if(adr_drv_stat==3)
10048  1ff7 b608          	ld	a,_adr_drv_stat
10049  1ff9 a103          	cp	a,#3
10050  1ffb 260b          	jrne	L3224
10051                     ; 2158 	adr_drv_stat=4;
10053  1ffd 35040008      	mov	_adr_drv_stat,#4
10054                     ; 2159 	adc_buff_[1]=temp_adc;
10056  2001 1e08          	ldw	x,(OFST-1,sp)
10057  2003 cf000b        	ldw	_adc_buff_+2,x
10059  2006 200f          	jra	L1224
10060  2008               L3224:
10061                     ; 2162 else if(adr_drv_stat==5)
10063  2008 b608          	ld	a,_adr_drv_stat
10064  200a a105          	cp	a,#5
10065  200c 2609          	jrne	L1224
10066                     ; 2164 	adr_drv_stat=6;
10068  200e 35060008      	mov	_adr_drv_stat,#6
10069                     ; 2165 	adc_buff_[9]=temp_adc;
10071  2012 1e08          	ldw	x,(OFST-1,sp)
10072  2014 cf001b        	ldw	_adc_buff_+18,x
10073  2017               L1224:
10074                     ; 2168 adc_buff[adc_ch][adc_cnt]=temp_adc;
10076  2017 b6c2          	ld	a,_adc_cnt
10077  2019 5f            	clrw	x
10078  201a 97            	ld	xl,a
10079  201b 58            	sllw	x
10080  201c 1f03          	ldw	(OFST-6,sp),x
10081  201e b6c3          	ld	a,_adc_ch
10082  2020 97            	ld	xl,a
10083  2021 a620          	ld	a,#32
10084  2023 42            	mul	x,a
10085  2024 72fb03        	addw	x,(OFST-6,sp)
10086  2027 1608          	ldw	y,(OFST-1,sp)
10087  2029 df001d        	ldw	(_adc_buff,x),y
10088                     ; 2174 adc_ch++;
10090  202c 3cc3          	inc	_adc_ch
10091                     ; 2175 if(adc_ch>=8)
10093  202e b6c3          	ld	a,_adc_ch
10094  2030 a108          	cp	a,#8
10095  2032 250e          	jrult	L1324
10096                     ; 2178 	adc_ch=2;
10098  2034 350200c3      	mov	_adc_ch,#2
10099                     ; 2179 	adc_cnt++;
10101  2038 3cc2          	inc	_adc_cnt
10102                     ; 2180 	if(adc_cnt>=16)
10104  203a b6c2          	ld	a,_adc_cnt
10105  203c a110          	cp	a,#16
10106  203e 2502          	jrult	L1324
10107                     ; 2182 		adc_cnt=0;
10109  2040 3fc2          	clr	_adc_cnt
10110  2042               L1324:
10111                     ; 2186 if((adc_cnt&0x03)==0)
10113  2042 b6c2          	ld	a,_adc_cnt
10114  2044 a503          	bcp	a,#3
10115  2046 264b          	jrne	L5324
10116                     ; 2190 	tempSS=0;
10118  2048 ae0000        	ldw	x,#0
10119  204b 1f08          	ldw	(OFST-1,sp),x
10120  204d ae0000        	ldw	x,#0
10121  2050 1f06          	ldw	(OFST-3,sp),x
10122                     ; 2191 	for(i=0;i<16;i++)
10124  2052 0f05          	clr	(OFST-4,sp)
10125  2054               L7324:
10126                     ; 2193 		tempSS+=(signed long)adc_buff[adc_ch][i];
10128  2054 7b05          	ld	a,(OFST-4,sp)
10129  2056 5f            	clrw	x
10130  2057 97            	ld	xl,a
10131  2058 58            	sllw	x
10132  2059 1f03          	ldw	(OFST-6,sp),x
10133  205b b6c3          	ld	a,_adc_ch
10134  205d 97            	ld	xl,a
10135  205e a620          	ld	a,#32
10136  2060 42            	mul	x,a
10137  2061 72fb03        	addw	x,(OFST-6,sp)
10138  2064 de001d        	ldw	x,(_adc_buff,x)
10139  2067 cd0000        	call	c_itolx
10141  206a 96            	ldw	x,sp
10142  206b 1c0006        	addw	x,#OFST-3
10143  206e cd0000        	call	c_lgadd
10145                     ; 2191 	for(i=0;i<16;i++)
10147  2071 0c05          	inc	(OFST-4,sp)
10150  2073 7b05          	ld	a,(OFST-4,sp)
10151  2075 a110          	cp	a,#16
10152  2077 25db          	jrult	L7324
10153                     ; 2195 	adc_buff_[adc_ch]=(signed short)(tempSS>>4);
10155  2079 96            	ldw	x,sp
10156  207a 1c0006        	addw	x,#OFST-3
10157  207d cd0000        	call	c_ltor
10159  2080 a604          	ld	a,#4
10160  2082 cd0000        	call	c_lrsh
10162  2085 be02          	ldw	x,c_lreg+2
10163  2087 b6c3          	ld	a,_adc_ch
10164  2089 905f          	clrw	y
10165  208b 9097          	ld	yl,a
10166  208d 9058          	sllw	y
10167  208f 90df0009      	ldw	(_adc_buff_,y),x
10168  2093               L5324:
10169                     ; 2206 adc_plazma_short++;
10171  2093 bec0          	ldw	x,_adc_plazma_short
10172  2095 1c0001        	addw	x,#1
10173  2098 bfc0          	ldw	_adc_plazma_short,x
10174                     ; 2221 }
10177  209a 5b09          	addw	sp,#9
10178  209c 85            	popw	x
10179  209d bf00          	ldw	c_lreg,x
10180  209f 85            	popw	x
10181  20a0 bf02          	ldw	c_lreg+2,x
10182  20a2 85            	popw	x
10183  20a3 bf00          	ldw	c_y,x
10184  20a5 85            	popw	x
10185  20a6 bf00          	ldw	c_x,x
10186  20a8 80            	iret
10250                     ; 2229 main()
10250                     ; 2230 {
10252                     	switch	.text
10253  20a9               _main:
10257                     ; 2232 CLK->ECKR|=1;
10259  20a9 721050c1      	bset	20673,#0
10261  20ad               L7524:
10262                     ; 2233 while((CLK->ECKR & 2) == 0);
10264  20ad c650c1        	ld	a,20673
10265  20b0 a502          	bcp	a,#2
10266  20b2 27f9          	jreq	L7524
10267                     ; 2234 CLK->SWCR|=2;
10269  20b4 721250c5      	bset	20677,#1
10270                     ; 2235 CLK->SWR=0xB4;
10272  20b8 35b450c4      	mov	20676,#180
10273                     ; 2237 delay_ms(200);
10275  20bc ae00c8        	ldw	x,#200
10276  20bf cd011d        	call	_delay_ms
10278                     ; 2238 FLASH_DUKR=0xae;
10280  20c2 35ae5064      	mov	_FLASH_DUKR,#174
10281                     ; 2239 FLASH_DUKR=0x56;
10283  20c6 35565064      	mov	_FLASH_DUKR,#86
10284                     ; 2240 enableInterrupts();
10287  20ca 9a            rim
10289                     ; 2243 adr_drv_v3();
10292  20cb cd1299        	call	_adr_drv_v3
10294                     ; 2246 BLOCK_INIT
10296  20ce 721a500c      	bset	20492,#5
10299  20d2 721a500d      	bset	20493,#5
10302  20d6 721b500e      	bres	20494,#5
10303                     ; 2248 t4_init();
10305  20da cd1e51        	call	_t4_init
10307                     ; 2250 		GPIOG->DDR|=(1<<0);
10309  20dd 72105020      	bset	20512,#0
10310                     ; 2251 		GPIOG->CR1|=(1<<0);
10312  20e1 72105021      	bset	20513,#0
10313                     ; 2252 		GPIOG->CR2&=~(1<<0);	
10315  20e5 72115022      	bres	20514,#0
10316                     ; 2255 		GPIOG->DDR&=~(1<<1);
10318  20e9 72135020      	bres	20512,#1
10319                     ; 2256 		GPIOG->CR1|=(1<<1);
10321  20ed 72125021      	bset	20513,#1
10322                     ; 2257 		GPIOG->CR2&=~(1<<1);
10324  20f1 72135022      	bres	20514,#1
10325                     ; 2259 init_CAN();
10327  20f5 cd15dc        	call	_init_CAN
10329                     ; 2264 GPIOC->DDR|=(1<<1);
10331  20f8 7212500c      	bset	20492,#1
10332                     ; 2265 GPIOC->CR1|=(1<<1);
10334  20fc 7212500d      	bset	20493,#1
10335                     ; 2266 GPIOC->CR2|=(1<<1);
10337  2100 7212500e      	bset	20494,#1
10338                     ; 2268 GPIOC->DDR|=(1<<2);
10340  2104 7214500c      	bset	20492,#2
10341                     ; 2269 GPIOC->CR1|=(1<<2);
10343  2108 7214500d      	bset	20493,#2
10344                     ; 2270 GPIOC->CR2|=(1<<2);
10346  210c 7214500e      	bset	20494,#2
10347                     ; 2277 t1_init();
10349  2110 cd1e62        	call	_t1_init
10351                     ; 2279 GPIOA->DDR|=(1<<5);
10353  2113 721a5002      	bset	20482,#5
10354                     ; 2280 GPIOA->CR1|=(1<<5);
10356  2117 721a5003      	bset	20483,#5
10357                     ; 2281 GPIOA->CR2&=~(1<<5);
10359  211b 721b5004      	bres	20484,#5
10360                     ; 2287 GPIOB->DDR&=~(1<<3);
10362  211f 72175007      	bres	20487,#3
10363                     ; 2288 GPIOB->CR1&=~(1<<3);
10365  2123 72175008      	bres	20488,#3
10366                     ; 2289 GPIOB->CR2&=~(1<<3);
10368  2127 72175009      	bres	20489,#3
10369                     ; 2291 GPIOC->DDR|=(1<<3);
10371  212b 7216500c      	bset	20492,#3
10372                     ; 2292 GPIOC->CR1|=(1<<3);
10374  212f 7216500d      	bset	20493,#3
10375                     ; 2293 GPIOC->CR2|=(1<<3);
10377  2133 7216500e      	bset	20494,#3
10378                     ; 2296 if(bps_class==bpsIPS) 
10380  2137 b604          	ld	a,_bps_class
10381  2139 a101          	cp	a,#1
10382  213b 260a          	jrne	L5624
10383                     ; 2298 	pwm_u=ee_U_AVT;
10385  213d ce000c        	ldw	x,_ee_U_AVT
10386  2140 bf0e          	ldw	_pwm_u,x
10387                     ; 2299 	volum_u_main_=ee_U_AVT;
10389  2142 ce000c        	ldw	x,_ee_U_AVT
10390  2145 bf1f          	ldw	_volum_u_main_,x
10391  2147               L5624:
10392                     ; 2306 	if(bCAN_RX)
10394  2147 3d0a          	tnz	_bCAN_RX
10395  2149 2705          	jreq	L1724
10396                     ; 2308 		bCAN_RX=0;
10398  214b 3f0a          	clr	_bCAN_RX
10399                     ; 2309 		can_in_an();	
10401  214d cd17e7        	call	_can_in_an
10403  2150               L1724:
10404                     ; 2311 	if(b100Hz)
10406                     	btst	_b100Hz
10407  2155 240a          	jruge	L3724
10408                     ; 2313 		b100Hz=0;
10410  2157 72110008      	bres	_b100Hz
10411                     ; 2322 		adc2_init();
10413  215b cd1e9f        	call	_adc2_init
10415                     ; 2323 		can_tx_hndl();
10417  215e cd16cf        	call	_can_tx_hndl
10419  2161               L3724:
10420                     ; 2326 	if(b10Hz)
10422                     	btst	_b10Hz
10423  2166 2419          	jruge	L5724
10424                     ; 2328 		b10Hz=0;
10426  2168 72110007      	bres	_b10Hz
10427                     ; 2330 		matemat();
10429  216c cd0e00        	call	_matemat
10431                     ; 2331 		led_drv(); 
10433  216f cd07e2        	call	_led_drv
10435                     ; 2332 	  link_drv();
10437  2172 cd08d0        	call	_link_drv
10439                     ; 2333 	  pwr_hndl();		//вычисление воздействий на силу
10441  2175 cd0c03        	call	_pwr_hndl
10443                     ; 2334 	  JP_drv();
10445  2178 cd0845        	call	_JP_drv
10447                     ; 2335 	  flags_drv();
10449  217b cd124e        	call	_flags_drv
10451                     ; 2336 		net_drv();
10453  217e cd1739        	call	_net_drv
10455  2181               L5724:
10456                     ; 2339 	if(b5Hz)
10458                     	btst	_b5Hz
10459  2186 240d          	jruge	L7724
10460                     ; 2341 		b5Hz=0;
10462  2188 72110006      	bres	_b5Hz
10463                     ; 2343 		pwr_drv();		//воздействие на силу
10465  218c cd0a8b        	call	_pwr_drv
10467                     ; 2344 		led_hndl();
10469  218f cd015f        	call	_led_hndl
10471                     ; 2346 		vent_drv();
10473  2192 cd0928        	call	_vent_drv
10475  2195               L7724:
10476                     ; 2349 	if(b2Hz)
10478                     	btst	_b2Hz
10479  219a 2404          	jruge	L1034
10480                     ; 2351 		b2Hz=0;
10482  219c 72110005      	bres	_b2Hz
10483  21a0               L1034:
10484                     ; 2360 	if(b1Hz)
10486                     	btst	_b1Hz
10487  21a5 24a0          	jruge	L5624
10488                     ; 2362 		b1Hz=0;
10490  21a7 72110004      	bres	_b1Hz
10491                     ; 2364 		temper_drv();			//вычисление аварий температуры
10493  21ab cd0f7e        	call	_temper_drv
10495                     ; 2365 		u_drv();
10497  21ae cd1055        	call	_u_drv
10499                     ; 2366           x_drv();
10501  21b1 cd1135        	call	_x_drv
10503                     ; 2367           if(main_cnt<1000)main_cnt++;
10505  21b4 9c            	rvf
10506  21b5 be51          	ldw	x,_main_cnt
10507  21b7 a303e8        	cpw	x,#1000
10508  21ba 2e07          	jrsge	L5034
10511  21bc be51          	ldw	x,_main_cnt
10512  21be 1c0001        	addw	x,#1
10513  21c1 bf51          	ldw	_main_cnt,x
10514  21c3               L5034:
10515                     ; 2368   		if((link==OFF)||(jp_mode==jp3))apv_hndl();
10517  21c3 b663          	ld	a,_link
10518  21c5 a1aa          	cp	a,#170
10519  21c7 2706          	jreq	L1134
10521  21c9 b64a          	ld	a,_jp_mode
10522  21cb a103          	cp	a,#3
10523  21cd 2603          	jrne	L7034
10524  21cf               L1134:
10527  21cf cd11af        	call	_apv_hndl
10529  21d2               L7034:
10530                     ; 2371   		can_error_cnt++;
10532  21d2 3c71          	inc	_can_error_cnt
10533                     ; 2372   		if(can_error_cnt>=10)
10535  21d4 b671          	ld	a,_can_error_cnt
10536  21d6 a10a          	cp	a,#10
10537  21d8 2505          	jrult	L3134
10538                     ; 2374   			can_error_cnt=0;
10540  21da 3f71          	clr	_can_error_cnt
10541                     ; 2375 			init_CAN();
10543  21dc cd15dc        	call	_init_CAN
10545  21df               L3134:
10546                     ; 2379 		volum_u_main_drv();
10548  21df cd1489        	call	_volum_u_main_drv
10550                     ; 2381 		pwm_stat++;
10552  21e2 3c07          	inc	_pwm_stat
10553                     ; 2382 		if(pwm_stat>=10)pwm_stat=0;
10555  21e4 b607          	ld	a,_pwm_stat
10556  21e6 a10a          	cp	a,#10
10557  21e8 2502          	jrult	L5134
10560  21ea 3f07          	clr	_pwm_stat
10561  21ec               L5134:
10562                     ; 2383 adc_plazma_short++;
10564  21ec bec0          	ldw	x,_adc_plazma_short
10565  21ee 1c0001        	addw	x,#1
10566  21f1 bfc0          	ldw	_adc_plazma_short,x
10567                     ; 2385 		vent_resurs_hndl();
10569  21f3 cd0000        	call	_vent_resurs_hndl
10571  21f6 ac472147      	jpf	L5624
11641                     	xdef	_main
11642                     	xdef	f_ADC2_EOC_Interrupt
11643                     	xdef	f_CAN_TX_Interrupt
11644                     	xdef	f_CAN_RX_Interrupt
11645                     	xdef	f_TIM4_UPD_Interrupt
11646                     	xdef	_adc2_init
11647                     	xdef	_t1_init
11648                     	xdef	_t4_init
11649                     	xdef	_can_in_an
11650                     	xdef	_net_drv
11651                     	xdef	_can_tx_hndl
11652                     	xdef	_can_transmit
11653                     	xdef	_init_CAN
11654                     	xdef	_volum_u_main_drv
11655                     	xdef	_adr_drv_v3
11656                     	xdef	_adr_drv_v4
11657                     	xdef	_flags_drv
11658                     	xdef	_apv_hndl
11659                     	xdef	_apv_stop
11660                     	xdef	_apv_start
11661                     	xdef	_x_drv
11662                     	xdef	_u_drv
11663                     	xdef	_temper_drv
11664                     	xdef	_matemat
11665                     	xdef	_pwr_hndl
11666                     	xdef	_pwr_drv
11667                     	xdef	_vent_drv
11668                     	xdef	_link_drv
11669                     	xdef	_JP_drv
11670                     	xdef	_led_drv
11671                     	xdef	_led_hndl
11672                     	xdef	_delay_ms
11673                     	xdef	_granee
11674                     	xdef	_gran
11675                     	xdef	_vent_resurs_hndl
11676                     	switch	.ubsct
11677  0001               _vent_resurs_tx_cnt:
11678  0001 00            	ds.b	1
11679                     	xdef	_vent_resurs_tx_cnt
11680                     	switch	.bss
11681  0000               _vent_resurs_buff:
11682  0000 00000000      	ds.b	4
11683                     	xdef	_vent_resurs_buff
11684                     	switch	.ubsct
11685  0002               _vent_resurs_sec_cnt:
11686  0002 0000          	ds.b	2
11687                     	xdef	_vent_resurs_sec_cnt
11688                     .eeprom:	section	.data
11689  0000               _vent_resurs:
11690  0000 0000          	ds.b	2
11691                     	xdef	_vent_resurs
11692  0002               _ee_IMAXVENT:
11693  0002 0000          	ds.b	2
11694                     	xdef	_ee_IMAXVENT
11695                     	switch	.ubsct
11696  0004               _bps_class:
11697  0004 00            	ds.b	1
11698                     	xdef	_bps_class
11699  0005               _vent_pwm:
11700  0005 0000          	ds.b	2
11701                     	xdef	_vent_pwm
11702  0007               _pwm_stat:
11703  0007 00            	ds.b	1
11704                     	xdef	_pwm_stat
11705  0008               _pwm_vent_cnt:
11706  0008 00            	ds.b	1
11707                     	xdef	_pwm_vent_cnt
11708                     	switch	.eeprom
11709  0004               _ee_DEVICE:
11710  0004 0000          	ds.b	2
11711                     	xdef	_ee_DEVICE
11712  0006               _ee_AVT_MODE:
11713  0006 0000          	ds.b	2
11714                     	xdef	_ee_AVT_MODE
11715                     	switch	.ubsct
11716  0009               _i_main_bps_cnt:
11717  0009 000000000000  	ds.b	6
11718                     	xdef	_i_main_bps_cnt
11719  000f               _i_main_sigma:
11720  000f 0000          	ds.b	2
11721                     	xdef	_i_main_sigma
11722  0011               _i_main_num_of_bps:
11723  0011 00            	ds.b	1
11724                     	xdef	_i_main_num_of_bps
11725  0012               _i_main_avg:
11726  0012 0000          	ds.b	2
11727                     	xdef	_i_main_avg
11728  0014               _i_main_flag:
11729  0014 000000000000  	ds.b	6
11730                     	xdef	_i_main_flag
11731  001a               _i_main:
11732  001a 000000000000  	ds.b	12
11733                     	xdef	_i_main
11734  0026               _x:
11735  0026 000000000000  	ds.b	12
11736                     	xdef	_x
11737                     	xdef	_volum_u_main_
11738                     	switch	.eeprom
11739  0008               _UU_AVT:
11740  0008 0000          	ds.b	2
11741                     	xdef	_UU_AVT
11742                     	switch	.ubsct
11743  0032               _cnt_net_drv:
11744  0032 00            	ds.b	1
11745                     	xdef	_cnt_net_drv
11746                     	switch	.bit
11747  0002               _bMAIN:
11748  0002 00            	ds.b	1
11749                     	xdef	_bMAIN
11750                     	switch	.ubsct
11751  0033               _plazma_int:
11752  0033 000000000000  	ds.b	6
11753                     	xdef	_plazma_int
11754                     	xdef	_rotor_int
11755  0039               _led_green_buff:
11756  0039 00000000      	ds.b	4
11757                     	xdef	_led_green_buff
11758  003d               _led_red_buff:
11759  003d 00000000      	ds.b	4
11760                     	xdef	_led_red_buff
11761                     	xdef	_led_drv_cnt
11762                     	xdef	_led_green
11763                     	xdef	_led_red
11764  0041               _res_fl_cnt:
11765  0041 00            	ds.b	1
11766                     	xdef	_res_fl_cnt
11767                     	xdef	_bRES_
11768                     	xdef	_bRES
11769                     	switch	.eeprom
11770  000a               _res_fl_:
11771  000a 00            	ds.b	1
11772                     	xdef	_res_fl_
11773  000b               _res_fl:
11774  000b 00            	ds.b	1
11775                     	xdef	_res_fl
11776                     	switch	.ubsct
11777  0042               _cnt_apv_off:
11778  0042 00            	ds.b	1
11779                     	xdef	_cnt_apv_off
11780                     	switch	.bit
11781  0003               _bAPV:
11782  0003 00            	ds.b	1
11783                     	xdef	_bAPV
11784                     	switch	.ubsct
11785  0043               _apv_cnt_:
11786  0043 0000          	ds.b	2
11787                     	xdef	_apv_cnt_
11788  0045               _apv_cnt:
11789  0045 000000        	ds.b	3
11790                     	xdef	_apv_cnt
11791                     	xdef	_bBL_IPS
11792                     	xdef	_bBL
11793  0048               _cnt_JP1:
11794  0048 00            	ds.b	1
11795                     	xdef	_cnt_JP1
11796  0049               _cnt_JP0:
11797  0049 00            	ds.b	1
11798                     	xdef	_cnt_JP0
11799  004a               _jp_mode:
11800  004a 00            	ds.b	1
11801                     	xdef	_jp_mode
11802                     	xdef	_pwm_i
11803                     	xdef	_pwm_u
11804  004b               _tmax_cnt:
11805  004b 0000          	ds.b	2
11806                     	xdef	_tmax_cnt
11807  004d               _tsign_cnt:
11808  004d 0000          	ds.b	2
11809                     	xdef	_tsign_cnt
11810                     	switch	.eeprom
11811  000c               _ee_U_AVT:
11812  000c 0000          	ds.b	2
11813                     	xdef	_ee_U_AVT
11814  000e               _ee_tsign:
11815  000e 0000          	ds.b	2
11816                     	xdef	_ee_tsign
11817  0010               _ee_tmax:
11818  0010 0000          	ds.b	2
11819                     	xdef	_ee_tmax
11820  0012               _ee_dU:
11821  0012 0000          	ds.b	2
11822                     	xdef	_ee_dU
11823  0014               _ee_Umax:
11824  0014 0000          	ds.b	2
11825                     	xdef	_ee_Umax
11826  0016               _ee_TZAS:
11827  0016 0000          	ds.b	2
11828                     	xdef	_ee_TZAS
11829                     	switch	.ubsct
11830  004f               _main_cnt1:
11831  004f 0000          	ds.b	2
11832                     	xdef	_main_cnt1
11833  0051               _main_cnt:
11834  0051 0000          	ds.b	2
11835                     	xdef	_main_cnt
11836  0053               _off_bp_cnt:
11837  0053 00            	ds.b	1
11838                     	xdef	_off_bp_cnt
11839                     	xdef	_vol_i_temp_avar
11840  0054               _flags_tu_cnt_off:
11841  0054 00            	ds.b	1
11842                     	xdef	_flags_tu_cnt_off
11843  0055               _flags_tu_cnt_on:
11844  0055 00            	ds.b	1
11845                     	xdef	_flags_tu_cnt_on
11846  0056               _vol_i_temp:
11847  0056 0000          	ds.b	2
11848                     	xdef	_vol_i_temp
11849  0058               _vol_u_temp:
11850  0058 0000          	ds.b	2
11851                     	xdef	_vol_u_temp
11852                     	switch	.eeprom
11853  0018               __x_ee_:
11854  0018 0000          	ds.b	2
11855                     	xdef	__x_ee_
11856                     	switch	.ubsct
11857  005a               __x_cnt:
11858  005a 0000          	ds.b	2
11859                     	xdef	__x_cnt
11860  005c               __x__:
11861  005c 0000          	ds.b	2
11862                     	xdef	__x__
11863  005e               __x_:
11864  005e 0000          	ds.b	2
11865                     	xdef	__x_
11866  0060               _flags_tu:
11867  0060 00            	ds.b	1
11868                     	xdef	_flags_tu
11869                     	xdef	_flags
11870  0061               _link_cnt:
11871  0061 0000          	ds.b	2
11872                     	xdef	_link_cnt
11873  0063               _link:
11874  0063 00            	ds.b	1
11875                     	xdef	_link
11876  0064               _umin_cnt:
11877  0064 0000          	ds.b	2
11878                     	xdef	_umin_cnt
11879  0066               _umax_cnt:
11880  0066 0000          	ds.b	2
11881                     	xdef	_umax_cnt
11882                     	switch	.eeprom
11883  001a               _ee_K:
11884  001a 000000000000  	ds.b	16
11885                     	xdef	_ee_K
11886                     	switch	.ubsct
11887  0068               _T:
11888  0068 00            	ds.b	1
11889                     	xdef	_T
11890  0069               _Udb:
11891  0069 0000          	ds.b	2
11892                     	xdef	_Udb
11893  006b               _Ui:
11894  006b 0000          	ds.b	2
11895                     	xdef	_Ui
11896  006d               _Un:
11897  006d 0000          	ds.b	2
11898                     	xdef	_Un
11899  006f               _I:
11900  006f 0000          	ds.b	2
11901                     	xdef	_I
11902  0071               _can_error_cnt:
11903  0071 00            	ds.b	1
11904                     	xdef	_can_error_cnt
11905                     	xdef	_bCAN_RX
11906  0072               _tx_busy_cnt:
11907  0072 00            	ds.b	1
11908                     	xdef	_tx_busy_cnt
11909                     	xdef	_bTX_FREE
11910  0073               _can_buff_rd_ptr:
11911  0073 00            	ds.b	1
11912                     	xdef	_can_buff_rd_ptr
11913  0074               _can_buff_wr_ptr:
11914  0074 00            	ds.b	1
11915                     	xdef	_can_buff_wr_ptr
11916  0075               _can_out_buff:
11917  0075 000000000000  	ds.b	64
11918                     	xdef	_can_out_buff
11919                     	switch	.bss
11920  0004               _adress_error:
11921  0004 00            	ds.b	1
11922                     	xdef	_adress_error
11923  0005               _adress:
11924  0005 00            	ds.b	1
11925                     	xdef	_adress
11926  0006               _adr:
11927  0006 000000        	ds.b	3
11928                     	xdef	_adr
11929                     	xdef	_adr_drv_stat
11930                     	xdef	_led_ind
11931                     	switch	.ubsct
11932  00b5               _led_ind_cnt:
11933  00b5 00            	ds.b	1
11934                     	xdef	_led_ind_cnt
11935  00b6               _adc_plazma:
11936  00b6 000000000000  	ds.b	10
11937                     	xdef	_adc_plazma
11938  00c0               _adc_plazma_short:
11939  00c0 0000          	ds.b	2
11940                     	xdef	_adc_plazma_short
11941  00c2               _adc_cnt:
11942  00c2 00            	ds.b	1
11943                     	xdef	_adc_cnt
11944  00c3               _adc_ch:
11945  00c3 00            	ds.b	1
11946                     	xdef	_adc_ch
11947                     	switch	.bss
11948  0009               _adc_buff_:
11949  0009 000000000000  	ds.b	20
11950                     	xdef	_adc_buff_
11951  001d               _adc_buff:
11952  001d 000000000000  	ds.b	320
11953                     	xdef	_adc_buff
11954                     	switch	.ubsct
11955  00c4               _mess:
11956  00c4 000000000000  	ds.b	14
11957                     	xdef	_mess
11958                     	switch	.bit
11959  0004               _b1Hz:
11960  0004 00            	ds.b	1
11961                     	xdef	_b1Hz
11962  0005               _b2Hz:
11963  0005 00            	ds.b	1
11964                     	xdef	_b2Hz
11965  0006               _b5Hz:
11966  0006 00            	ds.b	1
11967                     	xdef	_b5Hz
11968  0007               _b10Hz:
11969  0007 00            	ds.b	1
11970                     	xdef	_b10Hz
11971  0008               _b100Hz:
11972  0008 00            	ds.b	1
11973                     	xdef	_b100Hz
11974                     	xdef	_t0_cnt4
11975                     	xdef	_t0_cnt3
11976                     	xdef	_t0_cnt2
